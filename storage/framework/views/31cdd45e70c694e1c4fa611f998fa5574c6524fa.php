        ...
        <div class="col-md-10">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('sentence.New Appointment')); ?>ssss</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control patient_name multiselect-doctorino rounded-0" id="patient_name">
                                    <?php
                                    ...
                                    <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($patient->id); ?>"
                                            <?php if($lastPatientId == $patient->id): ?> selected <?php endif; ?>><?php echo e($patient->name); ?> (ID :
                            ...
                            <div class="form-group rounded-0">
                                ...
                                <input type="text" class="form-control target rounded-0 shadow-none" readonly="readonly"
                                    id="rdvdate">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control rounded-0 shadow-none" id="reason"></textarea>
                                <small id="emailHelp" class="form-text text-muted">Sélectionnez la date pour voir les plages
                                    horaires disponibles</small>
                            </div>
                        ...
                        <div class="col-md-8 col-sm-12">
                            <label for="date" class="my__label "><?php echo e(__('sentence.Available Times')); ?></label>
                            <hr>
                            <div class="row  myorders"></div>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/appointment/specialty/pediatre/create.blade.php ENDPATH**/ ?>