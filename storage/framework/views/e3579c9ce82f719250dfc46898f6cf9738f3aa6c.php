          ...
          <div class="col-md-8 col-sm-6">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="row">
                  <div class="col">
                    <button type="button" class="btn rounded-0  btn-primary btn-sm my-4 float-right" data-toggle="modal" data-target="#MedicalHistoryModel"><i class="fa fa-plus"></i> Add New</button>
                  </div>
                </div>
                  ...
                  foreach ($__currentLoopData as $prescription) : $__env->incrementLoopIndices();
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="<?php echo e(url('prescription/pdf/' . $prescription->id)); ?>" class="btn rounded-0  btn-outline-primary btn-circle btn-sm"><i class="fas fa-print"></i></a>
              ...
              <div class="tab-pane fade" id="documents" role="tabpanel" aria-labelledby="documents-tab">
                <div class="row">
                  <div class="col">
                    <button type="button" class="btn rounded-0  btn-primary btn-sm my-4 float-right" data-toggle="modal" data-target="#NewDocumentModel"><i class="fa fa-plus"></i> Add New</button>
                  </div>
                </div>
                    ...
                    <div class="col-md-4">
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <a href="<?php echo e(url('/uploads/' . $document->file)); ?>" class="btn rounded-0  btn-primary btn-sm" download><i class="fa fa-cloud-download-alt"></i> Download</a>
                          <a class="btn rounded-0  btn-danger btn-sm" data-toggle="modal" data-target="#DeleteModal" data-link="<?php echo e(url('document/delete/' . $document->id)); ?>"><i class="fa fa-trash"></i></a>
                        </div>
                      </div>
                    </div>
                  <?php endforeach;
                  ...
                  foreach ($__currentLoopData as $invoice) : $__env->incrementLoopIndices();
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo e(url('billing/pdf/' . $invoice->id)); ?>" class="btn rounded-0  btn-outline-primary btn-circle btn-sm"><i class="fas fa-print"></i></a>
