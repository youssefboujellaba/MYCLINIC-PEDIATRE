                ...
                <div class="col-8">
                    <form action="<?php echo e(route('billing.search')); ?>" method="GET" class="form-inline float-right">
                        <div class="form-group mx-2">
                            ...
                            <input type="text" class="form-control" id="reference" name="reference" value="<?php echo e($reference); ?>" placeholder="Référence de consultation">
                        </div>
                        <div class="form-group mx-2">
                            <label for="start_date" class="sr-only"><?php echo e(__('Start Date')); ?></label>
                            <input type="date" class="form-control" id="start_date" name="start_date" value="<?php echo e($startDate); ?>" placeholder="<?php echo e(__('Start Date')); ?>">
                        </div>
                        <div class="form-group mx-2">
                            <label for="end_date" class="sr-only"><?php echo e(__('End Date')); ?></label>
                            <input type="date" class="form-control" id="end_date" name="end_date" value="<?php echo e($endDate); ?>" placeholder="<?php echo e(__('End Date')); ?>">
                        </div>
...
<?php /**PATH C:\MAMP\htdocs\doctor-myclinc.tayssir.cloud\resources\views/billing/specialty/ophtamologie/search.blade.php ENDPATH**/ ?>