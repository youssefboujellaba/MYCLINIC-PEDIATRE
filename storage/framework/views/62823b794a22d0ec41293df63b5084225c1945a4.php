                            ...
                            <?php else: ?>
                                ...
                                <?php elseif($patient->Patient->gender == 'Famme' || $patient->Patient->gender == 'Female'): ?>
                                    <center><img src="<?php echo e(asset('img/woman.png')); ?>" class="img-profile rounded-circle img-fluid"
                                            width="256" height="256"></center>
                                <?php else: ?>
                                    <center><img src="<?php echo e(asset('img/girl.png')); ?>" class="img-profile rounded-circle img-fluid"
                                            width="256" height="256"></center>
                                <?php endif; ?>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create health history')): ?>
                                                <button type="button"
                                                    class="btn rounded-0  btn-primary btn-sm my-4 float-right"
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create appointment')): ?>
                                                <a type="button" class="btn rounded-0  btn-primary btn-sm my-4 float-right"
                                                    ...
                                                    <td align="center">
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit appointment')): ?>
                                                            <a data-rdv_id="<?php echo e($appointment->id); ?>"
                                                                ...
                                                                class="btn rounded-0  btn-outline-success btn-circle btn-sm"
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete appointment')): ?>
                                                            <a href="<?php echo e(url('appointment/delete/' . $appointment->id)); ?>"
                                                                class="btn rounded-0  btn-outline-danger btn-circle btn-sm"><i
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create prescription')): ?>
                                                    <a class="btn rounded-0  btn-primary btn-sm my-4 float-right"
                                                    ...
                                                    <td align="center">
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view prescription')): ?>
                                                            <a href="<?php echo e(url('prescription/view/' . $prescription->id)); ?>"
                                                                class="btn rounded-0  btn-outline-success btn-circle btn-sm"><i
                                                                    class="fa fa-eye"></i></a>
                                                        <?php endif; ?>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit prescription')): ?>
                                                            <a href="<?php echo e(url('prescription/edit/' . $prescription->id)); ?>"
                                                                class="btn rounded-0  btn-outline-warning btn-circle btn-sm"><i
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo e(url('/uploads/' . $document->file)); ?>"
                                                                class="btn rounded-0  btn-primary btn-sm" download>
                                                                <i class="fa fa-cloud-download-alt"></i> Télécharger
                                                            </a>
                                                            <button class="btn rounded-0  btn-primary  btn-sm"
                                                                onclick="viewPDF('<?php echo e(asset('/uploads/' . $document->file)); ?>')">
                                                                <i class="fa fa-eye"></i> Afficher
                                                            </button>
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit patient')): ?>
                                                                <a class="btn rounded-0  btn-danger btn-sm" data-toggle="modal"
                                                                    data-target="#DeleteModal"
                ...
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo e(route('document.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button class="btn rounded-0  btn-secondary" type="button"
                                data-dismiss="modal"><?php echo e(__('sentence.Close')); ?></button>
                            <button class="btn rounded-0  btn-primary text-white"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kuuhaku\Desktop\laravel\doctor-generalist.tayssir.cloud\resources\views/patient/view.blade.php ENDPATH**/ ?>