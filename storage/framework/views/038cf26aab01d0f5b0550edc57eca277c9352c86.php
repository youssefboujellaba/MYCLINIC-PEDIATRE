         ...
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    ?>
                    <input type="text" class="form-control" id="MnPayer" name="oldPayer" value="<?php echo e($totalPaymentValue); ?>" readonly>
                </div>
                           ...
                           <div class="field-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group mb-3">
                                   <input type="number" class="form-control" name="invoice_amount[]" value="<?php echo e($billing_item->invoice_amount); ?>" readonly>
                               ...
                               <div class="col-md-3" style="display: none;">
                                   ...
                                   <input type="number" class="form-control new_payer" placeholder="" id="new_payer" name="new_payer[]" <?php echo e($billing_item->payer); ?> >
                               </div>
        ...
        <div class="field-group row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control n_new_payer" placeholder="Payer" id="n_new_payer" name="n_new_payer" required>
                </div>
            </div>
            <div class="col-md-3">
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/billing/specialty/generalist/edit.blade.php ENDPATH**/ ?>