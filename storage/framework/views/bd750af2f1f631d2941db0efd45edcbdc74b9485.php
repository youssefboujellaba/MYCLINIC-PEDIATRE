            ...
            <form method="post" action="<?php echo e(route('doctorino_settings.store')); ?>" enctype="multipart/form-data">
               ...
               <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nomearabic" name="nomearabic" lang="ar" dir="rtl" value="<?php echo e(App\Setting::get_option('nomearabic')); ?>" >
                    </div>
                </div>
               <div class="form-group row">
               ...
               <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="ville" name="ville" value="<?php echo e(App\Setting::get_option('ville')); ?>" required>
                    </div>
                </div>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                     <input type="number" class="form-control" id="Currency" name="vat" value="<?php echo e(App\Setting::get_option('vat')); ?>">
                  </div>
               </div>
                <div class="form-group row">
                  <label for="Currency" class="col-sm-3 col-form-label">Montant</label>
                  <div class="col-sm-9">
                     <input type="number" class="form-control" id="montant" name="montant" value="<?php echo e(App\Setting::get_option('montant')); ?>">
                  </div>
               </div>
               <div class="form-group row">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generalist.tayssir.cloud\resources\views/settings/doctorino_settings.blade.php ENDPATH**/ ?>