                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control rounded-0 shoadow-none shadow-none rounded-0 multiselect-doctorino"
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <button type="submit"
                                    class="btn rounded-0  btn-primary btn-sm float-right">Sauvegarde</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <fieldset class="certificate">
                            <form>
                                <div class="form-row">
                                    ...
                                    <textarea class="form-control rounded-0 shadow-none " id="rapport" name="rapport" rows="5" placeholder=""></textarea>
   ...
   <section class="field-group">
    ...
    <div class="field-group row">
        ...
        <div class="form-group col-md-12">
            ...
            <select name="analyse_id[]" id="analyse" class="form-control rounded-0 shoadow-none shadow-none rounded-0 analyse">
        ...
        <div class="col-md-9">
            <div class="form-group-custom">
                <input type="text" name="description[]" class="form-control rounded-0 shadow-none " placeholder="<?php echo e(__('sentence.Description')); ?>">
            </div>
        </div>
        <br>
        <div class="col-md-3">
    ...
    <div class="field-group row">
        <div class="form-group col-md-12">
            ...
            <select type="text" name="radio_id[]" id="fai" class="form-control rounded-0 shoadow-none shadow-none rounded-0 fai">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kuuhaku\Desktop\laravel\doctor-generalist.tayssir.cloud\resources\views/prescription/create.blade.php ENDPATH**/ ?>