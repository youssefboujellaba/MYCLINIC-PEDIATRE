        ...
        <tbody>
          ...
          foreach ($__currentLoopData as $patient) : $__env->incrementLoopIndices();
            ...
            <tr>
              ...
              <td class="text-center"><label class="badge badge-primary-soft"><?php echo e($patient->created_at->format('d-m-Y')); ?></label></td>
              ...
              <td class="text-center">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view patient')) : ?>
                  <a href="<?php echo e(route('prescription.view_for_user', ['id' => $patient->id])); ?>" class="btn rounded-0  btn-outline-primary btn-sm"><i class="fa fa-eye"></i> Afficher</a>
                <?php endif; ?>
              </td>
              <td class="text-center">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view patient')) : ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-Ophtalmologie\doctor-ophtalmologie\resources\views/patient/all.blade.php ENDPATH**/ ?>