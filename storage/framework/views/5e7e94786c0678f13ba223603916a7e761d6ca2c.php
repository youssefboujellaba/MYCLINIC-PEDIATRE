            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create diagnostic analyse')): ?>
                        <a href="<?php echo e(route('analyse.create')); ?>" class="btn btn-primary btn-sm float-right"><i
...
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/analyse/specialty/pediatre/all.blade.php ENDPATH**/ ?>