            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create diagnostic analyse')): ?>
                        <a href="<?php echo e(route('radio.create')); ?>" class="btn btn-primary rounded-0 btn-sm float-right"><i
...
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/radio/specialty/ophtamologie/all.blade.php ENDPATH**/ ?>