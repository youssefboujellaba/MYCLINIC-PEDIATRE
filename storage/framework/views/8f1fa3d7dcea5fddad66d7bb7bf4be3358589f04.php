            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <option value="<?php echo e($prescription->user_id); ?>"><?php echo e($prescription->User->name); ?> - (<?php echo e(calculateAgeWithMonths($prescription->User->Patient->birthday)); ?>)</option>
                        ...
                        <form>
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputPoid" name="poid" placeholder="" style="width: 11rem;" value="<?php echo e($prescription->poid); ?>">
                                    <small id="poidHelp" class="form-text text-muted">Weight in kilograms</small>

                                </div>
                                <div class="form-group col-md-3">
                                    <label for="inputTaille">Taille</label>
                                    <input type="text" class="form-control" id="inputTaille" name="taille" placeholder="" style="width: 11rem;" value="<?php echo e($prescription->taille); ?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputsa" name="sa" placeholder="" style="width: 11rem;" value="<?php echo e($prescription->sa); ?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputPAD" name="pad" placeholder="" style="width: 11rem;" value="<?php echo e($prescription->pad); ?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputPouls" name="pouls" placeholder="" style="width: 11rem;" value="<?php echo e($prescription->pouls); ?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputfr" name="fr" placeholder="" style="width: 11rem;" value="<?php echo e($prescription->fr); ?>">
                                    <small id="poulsHelp" class="form-text text-muted">Fréquence respiratoire</small>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="inputTemp">température</label>
                                    <input type="text" class="form-control" id="inputTemp" name="temp" placeholder="" style="width: 11rem;" value="<?php echo e($prescription->temp); ?>">
                                    <small id="tempHelp" class="form-text text-muted">Température en °C</small>
                                </div>

                            </div>
                            <label for="motife">Rapport d'examen</label>
                            <textarea class="form-control" id="rapport" name="rapport" rows="5" placeholder="" value="<?php echo e($prescription->rapport); ?>"><?php echo e($prescription->rapport); ?></textarea>
                        </form>
                    </fieldset>
                </div>
            </div>
                ...
                <div class="card-body">
                    <fieldset class="drugs_labels">
                        <div class="repeatable">
                            ...
                            foreach ($__currentLoopData as $prescription_drug) : $__env->incrementLoopIndices();
                ...
                <div class="card-body">
                    <fieldset class="test_labels">
                        <div class="repeatable">
                            ...
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $prescription_test) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <div class="field-group row">
                                    <div class="form-group col-md-12" style="display: none;">
                                        <label for="test_id">Group d'analyse:</label>
                                        <select name="test_name[]" class="form-control rounded-0 shoadow-none test-select">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select name="analyse_id[]" class="form-control rounded-0 shoadow-none analyse-select">
                                            <?php $__currentLoopData = $analyses;
                                            $__env->addLoop($__currentLoopData);
                                            foreach ($__currentLoopData as $analysis) : $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($analysis->id); ?>" <?php echo e(old('analyse_id', $prescription_test->analyse_id) == $analysis->id ? 'selected' : ''); ?>>
                ...
                <div class="card-body">
                    <fieldset class="fai_labels">
                        <div class="repeatable">
                            ...
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $prescription_radio) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <div class="field-group row">
                                    <div class="form-group col-md-12">
                                        <label for="radio">radio</label>
                                        <select name="radio[]" class="form-control rounded-0 shoadow-none analyse-select">
                                            <option value="<?php echo e($prescription_radio->radio_id); ?>"><?php echo e($prescription_radio->radio_name); ?> </option>
                                            <?php $__currentLoopData = $listradio;
                                            $__env->addLoop($__currentLoopData);
                                            foreach ($__currentLoopData as $listradio) : $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($listradio->id); ?>">
                                                    <?php echo e($listradio->radio_name); ?>
                                    ...
                                    <div class="form-group col-md-9">
                                        <div class="form-group-custom">
                                            <input type="text" id="justif" name="justif[]" class="form-control" placeholder="<?php echo e(__('sentence.Description')); ?>" value="<?php echo e($prescription_radio->description); ?>">
                                            <input type="hidden" name="prescription_radio_id[]" value="<?php echo e($prescription_radio->id); ?>">
                        ...
                        <div class="form-group">
                            <a type="button" class="btn rounded-0  btn-sm btn-primary add text-white" align="center"><i class='fa fa-plus'></i> Ajoute Radio</a>
                        </div>
                    </fieldset>
                </div>
            </div>
...
<script type="text/template" id="fai_labels">
    <div class="field-group row">
            <div class="form-group col-md-12">
                <label>Radios </label>
                <select class="form-control rounded-0 shoadow-none multiselect-radio" name="radio[]" id="fai" tabindex="-1" aria-hidden="true" required>
                <?php $__currentLoopData = $listradio;
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $list) : $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generaliste\doctor-generaliste\resources\views/prescription/edit.blade.php ENDPATH**/ ?>