                        ...
                        <div id="collapseSettings" class="collapse" aria-labelledby="headingPages"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="nestedDropdown4">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create diagnostic test')): ?>
                                            <a class="collapse-item" href="<?php echo e(route('payment.create')); ?>">Ajoute un
                                                service</a>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all diagnostic tests')): ?>
                                            <a class="collapse-item" href="<?php echo e(route('payment.all')); ?>">Tous les
                                                services</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <?php if(empty(!$lastPatientId)): ?>
                                    <a href="<?php echo e(url('patient/view/' . $lastPatientId)); ?>" role="button">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                <center><img src="<?php echo e(asset('img/girll.jpg')); ?>" width="50"
                                                        height="50" class="d-none d-sm-inline-block rounded-circle mr-2">
                                                </center>
                                            <?php endif; ?>
                                    ...
                                    <?php echo e($imagePatient . 'dsadas'); ?>
                ...
                <footer class="sticky-footer bg-white">
                    <div class="px-4 my-auto">
                        <div class="copyright my-auto">
                            ...
                            <span style="float: right;">Version : Ophtalmologie - 2023V1</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
...
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/layouts/specialty/ophtamologie/master.blade.php ENDPATH**/ ?>