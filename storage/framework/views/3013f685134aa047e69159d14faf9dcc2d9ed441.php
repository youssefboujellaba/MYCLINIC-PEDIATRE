                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control rounded-0 shadow-none " type="number" name="deposited_amount"
                                id="DepositedAmount" value="<?php echo e($billing->deposited_amount); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="submit" value="<?php echo e(__('sentence.Update Invoice')); ?>"
                                class="btn rounded-0  btn-warning btn-block" align="center">
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('footer'); ?>
   ...
   <div class="field-group row">
    ...
    <div class="col">
       <div class="input-group mb-3">
        <input type="number" class="form-control rounded-0 shadow-none " placeholder="<?php echo e(__('sentence.Amount')); ?>" aria-label="Amount" aria-describedby="basic-addon1" name="invoice_amount[]" required>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kuuhaku\Desktop\laravel\doctor-generalist.tayssir.cloud\resources\views/billing/edit.blade.php ENDPATH**/ ?>