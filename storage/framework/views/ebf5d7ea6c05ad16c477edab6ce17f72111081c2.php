      ...
      <div class="col-md-4">
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               ...
               <div class="form-group">
                  <input type="submit" value="<?php echo e(__('sentence.Update Invoice')); ?>" class="btn rounded-0  btn-warning btn-block" align="center">
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="card-body">
               <fieldset class="billing_labels">
                  <div class="repeatable">
                     <?php $__currentLoopData = $billing_items;
                     $__env->addLoop($__currentLoopData);
                     foreach ($__currentLoopData as $billing_item) : $__env->incrementLoopIndices();
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor\resources\views/billing/edit.blade.php ENDPATH**/ ?>