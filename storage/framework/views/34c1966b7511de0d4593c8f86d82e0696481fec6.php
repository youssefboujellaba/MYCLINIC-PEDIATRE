                                                ...
                                                <div class="col">
                                                    ...
                                                    <?php $__currentLoopData = $rapports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rapport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        Nécessite la presance de <b><input type="text" class="form-line"
                                                                ...
                                                                value="<?php echo e($rapport->tuteur); ?>"></b> <br> <br> Aupres de lui
                                                        pendant <b><input type="number" class="form-line" name="nb_jour1"
                                                                id="nb_jour1" style="width: 80px;"
                                                                value="<?php echo e($rapport->nb_jour1); ?>"> </b> jours
                                                        à partir du <b><input type="date" class="form-line"
                                                                id="start_date" name="date_debut"
                                                                value="<?php echo e($rapport->date_debut); ?>"></b>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col" style="font-size: xx-large">
                                                ...
                                                <?php $__currentLoopData = $rapports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rapport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <p>Que l'état de santé de l'enfant
                                                        <strong><?php echo e($rapport->child); ?></strong>
                                                    </p>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\wamp641\www\MYCLINIC-PEDIATRE\MYCLINIC-PEDIATRE\resources\views/rapport/specialty/pediatre/edit.blade.php ENDPATH**/ ?>