      ...
      <div class="row">
         ...
         <div class="col-4">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create invoice')) : ?>
               <a href="<?php echo e(route('billing.create')); ?>" class="btn rounded-0  btn-primary btn-sm float-right"><i class="fa fa-plus"></i> <?php echo e(__('sentence.Create Invoice')); ?></a>
            <?php endif; ?>
         </div>
      </div>
   </div>
         ...
         <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
            <thead>
               <tr>
                  ...
                  <th class="text-center"><?php echo e(__('sentence.Amount')); ?> - <font class="text-danger">Due Balance</font>
                  </th>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete invoice')) : ?>
                           <a data-toggle="modal" data-target="#DeleteModal" data-link="<?php echo e(url('billing/delete/' . $invoice->id)); ?>" class="btn rounded-0  btn-outline-danger btn-circle btn-sm"><i class="fas fa-trash"></i></a>
                        <?php endif; ?>
                     </td>
                  </tr>
               <?php endforeach;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generaliste\doctor-generalist\resources\views/billing/all.blade.php ENDPATH**/ ?>