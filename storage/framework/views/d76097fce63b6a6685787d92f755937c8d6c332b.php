                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control rounded-0 patient_name multiselect-doctorino" id="patient_name">
                                    <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control target rounded-0   " readonly="readonly"
                                    id="rdvdate">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control rounded-0" id="reason"></textarea>
                                <small id="emailHelp" class="form-text text-muted">Sélectionnez la date pour voir les plages
                                    horaires disponibles</small>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/appointment/specialty/ophtamologie/create.blade.php ENDPATH**/ ?>