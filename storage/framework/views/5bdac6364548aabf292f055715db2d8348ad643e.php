                ...
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('analyse.store_edit')); ?>">
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo e(__('sentence.analyse Name')); ?><font
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control" id="analyse_name" name="analyse_name"
                                    value="<?php echo e($analyse->analyse_name); ?>">
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/analyse/specialty/generalist/edit.blade.php ENDPATH**/ ?>