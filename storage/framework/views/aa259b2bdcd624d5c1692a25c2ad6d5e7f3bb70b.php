                    ...
                    <form action="<?php echo e(route('purchase.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputPassword4" class="my__label">Nom du fournisseur</label><br>
                            ...
                            <div class="form-group  col-md-6">
                                <label for="inputPassword4" class="my__label">Date d'achat</label>
                        ...
                        <div class="form-row row d-flex justify-content-center">
                            <div class="col-8">
                                <label for="" class="my__label">Articles</label>
                                <select class="form-control rounded-0 multiselect-doctorino shadow-none" name="user_id"
                                    id="item" required style="padding: 20px;"
                                    oninvalid="this.setCustomValidity('Selectionner le items SVP!')">
                                    <option value="" selected disabled>Selectionner un items</option>
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>" data-sale_price="<?php echo e($item->sale_price); ?>"
                                            data-puchase_price="<?php echo e($item->purchase_price); ?>"
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/purchase/specialty/pediatre/create.blade.php ENDPATH**/ ?>