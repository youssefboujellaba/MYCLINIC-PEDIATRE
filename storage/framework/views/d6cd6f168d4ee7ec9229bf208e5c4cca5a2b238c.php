            ...
            <div class="row">
                ...
                <div class="col-4">
                    <a href="<?php echo e(route('prescription.create')); ?>"
                        class="btn btn-primary rounded-0 rounded-0 btn-sm float-right"><i class="fa fa-plus"></i>
                ...
                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center xs__screen">Date consultation</th>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-center  xs__screen"><?php echo e($prescription->created_at->format('d-m-Y')); ?></td>
...
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/prescription/specialty/ophtamologie/all.blade.php ENDPATH**/ ?>