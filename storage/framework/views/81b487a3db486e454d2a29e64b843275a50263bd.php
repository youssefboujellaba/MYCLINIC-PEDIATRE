                        ...
                        <fieldset class="drugs_labels">
                            <div class="chart-container">
                                <?php $__currentLoopData = $gras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img src="<?php echo e(asset('img/graph/' . $gra->image . '.png')); ?>" id="chart-image"
                                ...
                                <?php $__currentLoopData = $statistics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statistic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="point point-marker"
                                        style="left: <?php echo e($statistic->x); ?>px; top: <?php echo e($statistic->y); ?>px; background-color: red;"
                                        data-point-id="<?php echo e($statistic->id); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\doctor-myclinc.tayssir.cloud\resources\views/graph/edit.blade.php ENDPATH**/ ?>