    ...
    <form method="post" action="<?php echo e(route('prescription.update')); ?>">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('sentence.Patient informations')); ?></h6>dddddd
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <button type="submit" class="btn btn-success btn-sm float-right">Enregistre tout</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <fieldset class="fai_labels">
                            ...
                            <div class="form-group">
                                <a type="button" class="btn btn-sm btn-primary add text-white" align="center"><i class='fa fa-plus'></i>Ajouter </a>
                            </div>
                        </fieldset>
                    </div>
                ...
                <input type="submit" value="Enregistrer" class="btn btn-success" style="position: relative; left: 900px; margin-bottom: 20px;" align="center">
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/prescription/specialty/pediatre/edit.blade.php ENDPATH**/ ?>