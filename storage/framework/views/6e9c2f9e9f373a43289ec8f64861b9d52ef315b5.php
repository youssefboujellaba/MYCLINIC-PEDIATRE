                                        ...
                                        <div class="row">
                                            ...
                                            foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p style="text-align: right;"> أنا الموقع أسفله الدكتور(ة) <strong><?php echo e($rapport->name_medcien); ?> <input type="hidden" name="name_medcien" value="<?php echo e(App\Setting::get_option('nomearabic')); ?>"></strong></p>
                                                    <p style="text-align: right;">اشهد أنني فحصت يومه <input name="verifie" style="width: 600px; font-weight:bold;" lang="ar" dir="rtl" value="<?php echo e($rapport->verifie); ?>"> .. بطلب منه / منها</p>
                                                    <p style="text-align: right;"><strong><input name="patient_mariage" style="width: 800px; font-weight:bold;" lang="ar" dir="rtl" value="<?php echo e($rapport->patient_mariage); ?>"></strong> السيد (ة). </p>
                                                    <p style="text-align: right;"> <input name="patient_cin" style="width: 700px;  font-weight:bold;" lang="ar" dir="rtl" value="<?php echo e($rapport->patient_cin); ?>"> رقم البطاقة الوطنية (إن وجدة). </p>
                                                    ...
                                                    <textarea class="form-control" name="conclusion" id="conclusion" rows="5" lang="ar" dir="rtl" value="<?php echo e($rapport->conclusion); ?>"><?php echo e($rapport->conclusion); ?></textarea> <br>
                                                    <b>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\doctor\generalist\generalist.tayssir.cloud\resources\views/rapport/edit.blade.php ENDPATH**/ ?>