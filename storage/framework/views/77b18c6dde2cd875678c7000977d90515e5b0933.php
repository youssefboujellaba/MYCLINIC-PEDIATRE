...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row mb-2">
                ...
                <div class="col-6">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create drug')): ?>
                        <a href="<?php echo e(route('drug.create')); ?>" class="btn rounded-0  btn-primary btn-sm float-right"><i
            ...
            <div class="row">
                <div class="col-12">
                    <form class=" d-block form-inline mr-auto navbar-search" action="<?php echo e(route('drug.search')); ?>"
                        method="post">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kuuhaku\Desktop\laravel\doctor-generalist.tayssir.cloud\resources\views/drug/all.blade.php ENDPATH**/ ?>