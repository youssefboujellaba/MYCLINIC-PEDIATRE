                ...
                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center xs__screen"><?php echo e(__('sentence.Created at')); ?></th>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="text-center md__screen"><?php echo e($appointment->id); ?></td>
                                <td><a href="<?php echo e(url('patient/view/' . $appointment->user_id)); ?>">
                                        <?php echo e($appointment->User->name); ?> </a></td>
                                <td class="text-center"><label
                                        class="badge badge-primary-soft xs__screen"><?php echo e($appointment->reason); ?></label></td>
                                ...
                                <td class="text-center xs__screen"><?php echo e($appointment->created_at->format('d M Y H:i')); ?></td>
                                <td align="center">
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/appointment/specialty/ophtamologie/all.blade.php ENDPATH**/ ?>