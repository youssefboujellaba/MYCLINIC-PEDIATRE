                ...
                <div class="card-header py-3">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <a href="<?php echo e(route('patient.all')); ?>" class="btn rounded-0  btn-warning btn-sm float-right ">Tous les patinets</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" id="Arabicname" name="nameArabic" lang="ar" dir="rtl">
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generaliste\doctor-generalist\resources\views/patient/create.blade.php ENDPATH**/ ?>