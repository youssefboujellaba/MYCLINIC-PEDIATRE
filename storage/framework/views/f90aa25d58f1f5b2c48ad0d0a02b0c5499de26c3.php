        ...
        <tbody>
          ...
          foreach ($__currentLoopData as $patient) : $__env->incrementLoopIndices();
            ...
            <tr>
              ...
              <td class="text-center"><a href="<?php echo e(route('prescription.view_for_user', ['id' => $patient->id])); ?>" class="btn rounded-0  btn-outline-primary btn-sm"><i class="fa fa-eye"></i> View</a></td>
