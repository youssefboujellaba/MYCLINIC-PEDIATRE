...
<body class="bg-gradient-primary overflow-hidden">
    <div class="row">
        <div class="d-md-block d-none col-md-6 my-pub">
            <img src="<?php echo e(asset('img/bg-pub.jpg')); ?>" class="my-img-fluid">
        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <span class="my-copyright-absolute">
...
<?php /**PATH C:\wamp641\www\MYCLINIC-PEDIATRE\MYCLINIC-PEDIATRE\resources\views/auth/specialty/pediatre/login.blade.php ENDPATH**/ ?>