         ...
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <div class="form-group">
                  ...
                  <select class="form-control rounded-0 shoadow-none select2 select2-hidden-accessible" id="drug" tabindex="-1" name="patient_id" aria-hidden="true">
                     <?php
                     ...
                     foreach ($__currentLoopData as $patient) : $__env->incrementLoopIndices();
                        ...
                        <option value="<?php echo e($patient->id); ?>" <?php if ($lastPatientId == $patient->id) : ?> selected <?php endif; ?>><?php echo e($patient->name); ?></option>
                     <?php endforeach;
                     $__env->popLoop();
                     $loop = $__env->getLastLoop(); ?>
                  </select>
               ...
               <div class="form-group">
                  <label for="DepositedAmount">Montant déposé</label>
                  <input class="form-control" type="number" name="deposited_amount" id="DepositedAmount">
               </div>

               <div class="form-group">
                  <label for="DueAmount">Somme due</label>
               ...
               <div class="form-group">
                  <input type="submit" value="<?php echo e(__('sentence.Create Invoice')); ?>" class="btn rounded-0  btn-warning btn-block" align="center">
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <fieldset class="billing_labels">
                  ...
                  <div class="form-group">
                     <a type="button" class="btn rounded-0  btn-primary btn-sm add text-white" align="center"><i class='fa fa-plus'></i> <?php echo e(__('sentence.Add Item')); ?></a>
                  </div>
               </fieldset>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\doctor\generalist\medecin.tayssir.cloud\resources\views/billing/create.blade.php ENDPATH**/ ?>