                                        ...
                                        <div class="row justify-content-center" style="margin-top: 70px;">
                                            <div class="col">
                                                <div class="text-center">
                                                    <b>
                                                        <?php echo e($rapport->patient_title); ?> <?php echo e($rapport->child); ?>

                                                    </b>
                                                </div>
                                                <div class="text-center" style="margin-top: 25px;">
                                                    <?php echo e($rapport->ophtalinput1); ?> <?php if(isset($rapport->ophtalinput2)): ?>
                                                        + <?php echo e($rapport->ophtalinput2); ?>

                                                    <?php endif; ?>
                                                </div>
                                                <div style=" position: relative; left: 60%;">
                                                    <?php echo e($rapport->nb_jour); ?>DH
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row justify-content-center" style="margin-top: 100px;">
                                            <div class="col">
                                                ...
                                                <?php $__currentLoopData = $rapports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rapport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <ul>
                                                        <?php if(isset($rapport->ophtalinput3)): ?>
                                                            <li><?php echo e($rapport->ophtalinput3); ?></li>
                                                        <?php endif; ?>
                                                        <?php if(isset($rapport->ophtalinput4)): ?>
                                                            <li><?php echo e($rapport->ophtalinput4); ?></li>
                                                        <?php endif; ?>
                                                        <?php if(isset($rapport->ophtalinput5)): ?>
                                                            <li><?php echo e($rapport->ophtalinput5); ?></li>
                                                        <?php endif; ?>
                                                    </ul>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <br><br>
                            ...
                            <div class="col-12">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-100" style="font-size: x-large">
                                        <div class="col" style="font-size: xx-large">
                                            <?php $__currentLoopData = $rapports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rapport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="text-center"><strong><?php echo e($rapport->patient_title); ?>

                                                        <?php echo e($rapport->child); ?></strong></div>
                                                <br>
                                                <b>Faire SVP : </b>
                                                <ul>
                                                    <?php if(isset($rapport->ophtalinput3)): ?>
                            ...
                            <div class="col-12">
                                <div class="card-body">
                                    ...
                                    <div class="col" style="font-size: xxx-large">
                                        ...
                                        <br>
                                        <div class="text-center" style="margin-top: 25px;">
                                            <?php echo e($rapport->ophtalinput1); ?> + <?php echo e($rapport->ophtalinput2); ?>:
                                        </div>
                                        <br>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/rapport/specialty/ophtamologie/view.blade.php ENDPATH**/ ?>