...
<?php if (!empty($prescription)) : ?>
    <div class="d-flex justify-content-end">
        <a href="<?php echo e(url('prescription/edit/' . $prescription->id)); ?>" class="btn rounded-0  btn-primary " style="margin-right:20px;">Modifier</a>
        <a href="<?php echo e(route('prescription.create')); ?>" class="btn rounded-0  btn-primary" style="margin-right:20px;"><?php echo e(__('sentence.New Prescription')); ?></a>
        <a href="<?php echo e(route('prescription.all')); ?>" class="btn rounded-0  btn-warning" style="margin-right:20px;"><?php echo e(__('sentence.All Prescriptions')); ?></a>
    </div>
    <br>
        ...
        <div class="row justify-content-center" style="font-size: xx-large">
            <div class="col">
                ...
                foreach ($__currentLoopData as $radio) : $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop(); ?>
                    <b>
                        <li style="margin-left: 120px;"><?php if (empty(!$radio->radio_name)) : ?> <?php echo e($radio->radio_name); ?> <?php endif; ?></li>
                    </b>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generaliste\doctor-generalist\resources\views/prescription/view.blade.php ENDPATH**/ ?>