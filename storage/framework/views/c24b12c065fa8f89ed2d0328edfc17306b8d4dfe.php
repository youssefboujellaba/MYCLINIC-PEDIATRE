...
<?php elseif(env('APP_NAME') == 'DENT'): ?>
    <?php echo $__env->first(['appointment.custom.dentiste_create', 'appointment.specialty.dentiste.create'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\doctor-myclinc.tayssir.cloud\resources\views/appointment/create.blade.php ENDPATH**/ ?>