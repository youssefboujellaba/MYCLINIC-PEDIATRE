                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control rounded-0 shoadow-none shadow-none rounded-0 multiselect-doctorino" name="user_id" id="PatientID" required>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#label').change(function() {
                ...
                if (selectedLabelId) {
                    var imageURL = '<?php echo e(asset('img/graph')); ?>' + '/' + selectedLabel +
                        '.png'; // Use selectedLabel for the image URL
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kuuhaku\Desktop\laravel\doctor-generalist.tayssir.cloud\resources\views/graph/create.blade.php ENDPATH**/ ?>