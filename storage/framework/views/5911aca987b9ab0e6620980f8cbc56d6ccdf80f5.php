            ...
            <div class="row">
               ...
               <div class="col-4">
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view patient')) : ?>
                     <a href="<?php echo e(route('patient.view', ['id' => $patient->id])); ?>" class="btn rounded-0  btn-primary btn-sm float-right "><i class="fa fa-eye"></i> <?php echo e(__('sentence.View Patient')); ?></a>
                  <?php endif; ?>
               </div>
            </div>
         </div>
