                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <fieldset class="rapport_labels_template repeatable">
                            ...
                            <?php $__currentLoopData = $prescription_rapport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rapport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-row">
                                <div class="col-md-9">
                                    <br>
                                    <input type="text" name="value[]" class="form-control" value="<?php echo e($rapport->value); ?>" readonly>
                                </div>
                                <div class="col-md-3">
                                    <br>
                                    <a href="<?php echo e(route('remove-rapport', ['id' => $rapport->id])); ?>" class="btn rounded-0  btn-danger btn-sm text-white span-2"><i
                                            class="fa fa-times-circle"></i> <?php echo e(__('sentence.Remove')); ?></a>
                                </div>
                                <label for="rapport">Rapport d'examen</label>
                                <textarea class="form-control rounded-0 shadow-none analyse" name="rapport[]" placeholder=""><?php echo e($rapport->rapport); ?></textarea>
                                <input type="hidden" name="prescription_rapport_id[]" value="<?php echo e($rapport->id); ?>" >
                            </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-10">
                                <select class="form-control" id="acte" name="acte">
                                    ...
                                    <?php $__currentLoopData = $actes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($act->id); ?>" data-acte-ref="<?php echo e($act->ref); ?>" data-acte-cout="<?php echo e($act->cout); ?>"><?php echo e($act->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <br>
                            <table  id="acteTable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $consultationact; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($acte->ref); ?></td>
                                        <td><?php echo e($acte->name); ?></td>
                                        <td><select name='status[]' class='form-control'>
                                                <option value="<?php echo e($acte->status); ?>"><?php echo e($acte->status); ?></option>
                                                <option value='En cours'>En cours</option>
                                                <option value='Terminé'>Terminé</option>
                                            </select>
                                        </td>
                                        <td><?php echo e($acte->dent); ?></td>
                                        <td><input type="number" name="prix[]" class="form-control" value="<?php echo e($acte->prix); ?>"></td>



                                        </td><td><a href="<?php echo e(route('remove-acte', ['id' => $acte->id])); ?>" class="btn"><i class='fas fa-trash'></i></a></td>
                                        <input type="hidden" name="prescription_consultation_id[]" id="prescription_id" value="<?php echo e($acte->prescription_id); ?>">
                                        <input type="hidden" name="act_id[]" id="act_id" value="<?php echo e($acte->id); ?>">
                                        <input type="hidden" name="consultation_act_id[]" id="consultation_act_id" value="<?php echo e($acte->id); ?>">
                                        <input type="hidden" name="observation[]" id="observation" value="<?php echo e($acte->observation); ?>">
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\doctor-myclinc.tayssir.cloud\resources\views/prescription/specialty/dentiste/edit.blade.php ENDPATH**/ ?>