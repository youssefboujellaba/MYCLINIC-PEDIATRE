...
<body class="bg-gradient-primary overflow-hidden">
    <div class="row">
        <div class="d-md-block d-none col-md-6 my-pub">
            <img src="<?php echo e(asset('img/pexels-daniel-frank-305566.jpg')); ?>" class="my-img-fluid my__img__login">
        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="copyright my-auto p-2">
                                        <div class="text-right">Dentiste - <?php echo e(date('Y')); ?> V2</div>
                                    </div>
...
<?php /**PATH C:\MAMP\htdocs\doctor-myclinc.tayssir.cloud\resources\views/auth/specialty/dentiste/login.blade.php ENDPATH**/ ?>