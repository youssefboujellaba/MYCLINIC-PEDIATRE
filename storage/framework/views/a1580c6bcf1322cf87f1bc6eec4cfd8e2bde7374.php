            ...
            <div class="row">
               <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                     ...
                     <select class="form-control rounded-0 shoadow-none patient_name multiselect-doctorino" id="patient_name">
                        <?php
                        ...
                        foreach ($__currentLoopData as $patient) : $__env->incrementLoopIndices();
                           ...
                           <option value="<?php echo e($patient->id); ?>" <?php if ($lastPatientId == $patient->id) : ?> selected <?php endif; ?>><?php echo e($patient->name); ?> (ID : <?php echo e($patient->id); ?>)</option>
                        <?php endforeach;
                        $__env->popLoop();
                        $loop = $__env->getLastLoop(); ?>
                     </select>
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control rounded-0 shoadow-none target" readonly="readonly" id="rdvdate">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            ...
            <a class="btn rounded-0  btn-primary text-white" onclick="event.preventDefault();
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-Ophtalmologie\doctor-ophtalmologie\resources\views/appointment/create.blade.php ENDPATH**/ ?>