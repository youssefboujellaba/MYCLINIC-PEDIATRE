                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    name="user_id" id="PatientID" disabled>
                                    ...
                                    <?php $__currentLoopData = $statistics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statistic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(!is_null($statistic->x) && !is_null($statistic->y)): ?>
                                            <div class="point point-marker"
                                                ...
                                                data-point-id="<?php echo e($statistic->id); ?>"></div>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </fieldset>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/graph/view.blade.php ENDPATH**/ ?>