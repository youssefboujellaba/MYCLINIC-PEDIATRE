                    ...
                    <div class="card-body">
                                ...
                                <div class="form-group" id="print_area">
                                    <div class="form-group">
                                        ...
                                        foreach ($__currentLoopData as $setting) : $__env->incrementLoopIndices();
                                            $loop = $__env->getLastLoop(); ?>
                                            Je soussigne <b><label value="<?php echo e($setting->option_value); ?>"><?php echo e($setting->option_value); ?></label></b> <br><br> Que l'état de santé de
                        ...
                        <fieldset style="border: 1px solid #333; padding: 10px;" id="fieldset5">
                            <div class="form-group">
                                ...
                                <p style="text-align: right;">اشهد أنني فحصت يومه <input type="text" name="verifie" id="verifie" lang="ar" dir="rtl" style="width: 345px;"> بطلب منه / منها</p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-Ophtalmologie\doctor-ophtalmologie\resources\views/rapport/create.blade.php ENDPATH**/ ?>