...
<form method="post" action="<?php echo e(route('prescription.update')); ?>">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <input type="submit" value="Sauvegarde" class="btn rounded-0  btn-primary " style="position: relative; left: 900px; margin-bottom: 20px;" align="center">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                            ...
                            foreach ($__currentLoopData as $prescription_radio) : $__env->incrementLoopIndices();
                                ...
                                <div class="field-group row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select name="radio_id[]" class="form-control rounded-0 shoadow-none radio-select">
                                    ...
                                    <div class="form-group col-md-9">
                                        <div class="form-group-custom">
                                            <input type="text" id="justif" name="justif[]" class="form-control" placeholder="<?php echo e(__('sentence.Description')); ?>" value="<?php echo e($prescription_radio->justif); ?>">
...
<script type="text/template" id="fai_labels">
    <div class="field-group row">
            <div class="form-group col-md-12">
                <label>Radios </label>
                <select class="form-control rounded-0 shoadow-none multiselect-radio" name="radio_id[]" id="fai" tabindex="-1" aria-hidden="true" required>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generaliste\doctor-generalist\resources\views/prescription/edit.blade.php ENDPATH**/ ?>