                ...
                <div class="col-3">
                    <form  action="<?php echo e(route('dayfilter.search')); ?>" method="get">
                        <div class="input-group"> <!-- Wrap input and button within input-group -->
                            <input type="date" class="form-control" name="datefilter" value="<?php echo e($startDate); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/appointment/dayfilter.blade.php ENDPATH**/ ?>