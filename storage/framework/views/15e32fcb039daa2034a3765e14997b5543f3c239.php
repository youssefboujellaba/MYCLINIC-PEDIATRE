                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <?php endif; ?>
                            <?php if(isset($patient->Patient->nomPere)): ?>
                                <p><b>Nom du pére : </b> <?php echo e($patient->Patient->nomPere); ?></p>
                            <?php endif; ?>

                            <?php if(isset($patient->Patient->professionPere)): ?>
                                <p><b>Profession du pere : </b> <?php echo e($patient->Patient->professionPere); ?></p>
                            <?php endif; ?>

                            <?php if(isset($patient->Patient->nomMere)): ?>
                                <p><b>Nom de la mere : </b> <?php echo e($patient->Patient->nomMere); ?></p>
                            <?php endif; ?>

                              <?php if(isset($patient->Patient->professionMere)): ?>
                                <p><b>Profession de la mere : </b> <?php echo e($patient->Patient->professionMere); ?></p>
                            <?php endif; ?>
                                        ...
                                        <?php if(isset($history->traitement)): ?>
                                            <div class="row mt-2">
                                                <div class="col">
                                                    ...
                                                    <?php endif; ?>
                                                    <textarea class="form-control alert alert-danger" name="traitement" id="myTextarea" rows="4" placeholder="" value="<?php echo e($history->traitement); ?>" readonly><?php echo e($history->traitement); ?></textarea>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="modal-body">
                    <form id="antecedentsForm" method="post" action="<?php echo e(route('anticedents.store')); ?>">
                        <div class="form-group">
                                <label for="antecedents_name">Type de l'antécédent *</label>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\wamp641\www\MYCLINIC-PEDIATRE\MYCLINIC-PEDIATRE\resources\views/patient/specialty/pediatre/view.blade.php ENDPATH**/ ?>