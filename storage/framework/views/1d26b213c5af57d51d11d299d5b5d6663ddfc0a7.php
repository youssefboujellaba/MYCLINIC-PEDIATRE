...
<div id="print_radio" style="display: none;">
    ...
    <div class="row">
        <div class="col" style="font-size: xx-large; margin-left: 25px; margin-right: 25px;">
            <p>
                <b style="float: right;">Temara ,<?php echo e(__('sentence.On')); ?> : <?php echo e($prescription->created_at->format('d-m-Y')); ?></b>
            </p>
            <br>
    ...
    <?php if (count($prescription_radios) > 0) : ?>
        ...
        <div class="row justify-content-center" style="font-size: xx-large">
            <div class="col">
                ...
                foreach ($__currentLoopData as $radio) : $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop(); ?>
                    <li style="margin-left: 800px; direction: rtl;"><?php if (empty(!$radio->radio)) : ?> <?php echo e($radio->radio); ?></li>
                    <strong>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\doctor\generalist\medecin.tayssir.cloud\resources\views/prescription/view.blade.php ENDPATH**/ ?>