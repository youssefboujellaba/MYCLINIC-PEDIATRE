    ...
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo e(route('history.store')); ?>" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="row">
            <div class="col">
              <input type="text" class="form-control" name="title" placeholder="Antécédent/Maladie">
              <input type="hidden" name="patient_id" value="<?php echo e($patient->id); ?>">
              <?php echo e(csrf_field()); ?>
          ...
          <div class="row mt-2">
            <div class="col">
              <input type="text" class="form-control" name="periode" placeholder="La durée du traitement">
            </div>
          </div>
          <div class="row mt-2">
            <div class="col">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-Ophtalmologie\doctor-ophtalmologie\resources\views/patient/view.blade.php ENDPATH**/ ?>