...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        ...
        #myTextarea {
            ...
            background-color: #f5f5f5; /* Set a custom background color */
            opacity: 0.7; /* Optionally reduce opacity to visually indicate disabled state */
            /* Add any other styling you want for the disabled state */
        }

        /* To style the enabled state differently */
        #myTextarea:not([disabled]) {
            background-color: white; /* Set a different background color for enabled state */
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generalist.tayssir.cloud\resources\views/patient/view.blade.php ENDPATH**/ ?>