                        ...
                        <?php if(empty(!$lastPatientId)): ?>
                            <a href="<?php echo e(url('patient/view/'.$lastPatientId)); ?>" role="button"
                               style="position: relative ; top: 12px; right: 5px;">
                                ...
                                <?php elseif($genderPation == 'Femme' || $genderPation == 'Female'): ?>
...
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/layouts/specialty/generalist/master.blade.php ENDPATH**/ ?>