                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <fieldset class="fai_labels">
                            <div class="repeatable">
                                <?php $__currentLoopData = $prescription_radio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $radio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="field-group row">
                                        <div class="form-group col-md-12">
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\doctor-myclinc.tayssir.cloud\resources\views/prescription/specialty/pediatre/edit.blade.php ENDPATH**/ ?>