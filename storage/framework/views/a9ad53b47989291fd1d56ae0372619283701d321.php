                ...
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" id="age" name="age" placeholder="" value="<?php echo e($prescription->age); ?>">
                        </div>
                        ...
                        <form>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputPC" name="pc" placeholder="" style="width: 11rem;" value="<?php echo e($prescription->pc); ?>">
                            ...
                            <textarea class="form-control" id="rapport" name="rapport" rows="15" placeholder="" value="<?php echo e($prescription->rapport); ?>"><?php echo e($prescription->rapport); ?></textarea>
                        </form>
                    </fieldset>
                </div>
            </div>
                            ...
                            foreach ($__currentLoopData as $radio) : $__env->incrementLoopIndices();
                                ...
                                <div class="field-group row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="radio[]" id="fai" class="form-control" value="<?php echo e($radio->radio); ?>">
                                    </div>
                                    <div class="col-md-9">
                                        <div class="form-group-custom">
                                            <input type="hidden" name="prescription_radio_id[]" value="<?php echo e($radio->id); ?>">

                                            <textarea type="text" name="justif[]" class="form-control" rows="3" placeholder="Justificatif" value="<?php echo e($radio->justif); ?>"><?php echo e($radio->justif); ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <br>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\medecin.tayssir.cloud\resources\views/prescription/edit.blade.php ENDPATH**/ ?>