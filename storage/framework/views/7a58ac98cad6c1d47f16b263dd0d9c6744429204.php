                        ...
                        <div class="col-md-4 col-sm-6">
                            <?php if(empty(!$patient->image)): ?>
                                <center><img src="<?php echo e(asset('uploads/' . $patient->image)); ?>"
                                        class="img-profile rounded-circle img-fluid my-img-pro" width="256" height="256">
                                </center>
                            <?php else: ?>
                                <?php if($patient->Patient->gender == 'Male' || $patient->Patient->gender == 'Homme'): ?>
                                    <center><img src="<?php echo e(asset('img/man.png')); ?>" class="img-profile rounded-circle img-fluid"
                                            width="256" height="256"></center>
                                <?php elseif($patient->Patient->gender == 'Garçon' || $patient->Patient->gender == 'Boy'): ?>
                                    <center><img src="<?php echo e(asset('img/boy.jpg')); ?>" class="img-profile rounded-circle img-fluid"
                                            width="256" height="256"></center>
                                <?php elseif($patient->Patient->gender == 'Famme' || $patient->Patient->gender == 'Female'): ?>
                                    <center><img src="<?php echo e(asset('img/woman.png')); ?>" class="img-profile rounded-circle img-fluid"
                                            width="256" height="256"></center>
                                <?php else: ?>
                                    <center><img src="<?php echo e(asset('img/girl.jpeg')); ?>" class="img-profile rounded-circle img-fluid"
                                            width="256" height="256"></center>
                                <?php endif; ?>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="profile" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create health history')): ?>
                                                <button type="button" class="btn btn-primary rounded-0 btn-sm my-4 float-right"
                                                    data-toggle="modal" data-target="#MedicalHistoryModel">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete health history')): ?>
                                                        <span class="float-right">
                                                            <i class="fa fa-trash" data-toggle="modal"
                                                                ...
                                                                data-link="<?php echo e(url('history/delete/' . $history->id)); ?>"></i>
                                                        </span>
                                                    <?php endif; ?>
                                                    <form id="updateForm<?php echo e($history->id); ?>" class="update-form">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="hidden" name="history_id"
                                                            value="<?php echo e($history->id); ?>">
                                                        <div class="input-group">
                                                            <textarea class="form-control alert alert-danger" name="traitement" id="myTextarea<?php echo e($history->id); ?>"
                                                                rows="4" placeholder=""><?php echo e($history->traitement); ?></textarea>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <center><br><br> <b class="text-muted">Aucun antécédent médical n'a été trouvé</b>
                                        </center>
                                    <?php endif; ?>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create appointment')): ?>
                                                <a type="button" class="btn btn-primary rounded-0 btn-sm my-4 float-right"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit patient')): ?>
                                                    <button type="button"
                                                        class="btn btn-primary rounded-0 btn-sm my-4 float-right"
                                    ...
                                    <div class="tab-pane fade" id="Billing" role="tabpanel" aria-labelledby="Billing-tab">
                                            ...
                                            <div class="col-lg-4 mb-4">
                                                <div class="card bg-danger text-white shadow">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="text-white small">
                                                            <?php echo e(Collect($invoices)->where('payment_status', 'Partially Paid')->sum('due_amount')); ?>
                                        ...
                                        <table class="table">
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                ...
                                                <td colspan="6" align="center"><br><br> <b
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.update-form').submit(function(e) {
                    ...
                    var form = $(this);
                    var historyId = form.find('input[name="history_id"]').val();
                    var updatedText = form.find('textarea[name="traitement"]').val();

                    $.ajax({
                        type: 'POST',
                        url: '/history/update', // Replace with the actual route to your update function
                        data: {
                            _token: '<?php echo e(csrf_token()); ?>', // If you're using Laravel's CSRF protection
                            history_id: historyId,
                            traitement: updatedText
                        },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/patient/specialty/pediatre/view.blade.php ENDPATH**/ ?>