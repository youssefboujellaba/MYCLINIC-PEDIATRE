      ...
      <div class="col-md-4">
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               ...
               <div class="form-group">
                  <input type="submit" value="Enregistrer" class="btn btn-primary btn-block" align="center">
               </div>
            </div>
         </div>
      </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generalist.tayssir.cloud\resources\views/billing/edit.blade.php ENDPATH**/ ?>