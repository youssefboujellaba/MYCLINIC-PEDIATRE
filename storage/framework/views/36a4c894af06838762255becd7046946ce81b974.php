                    ...
                    <tbody>
                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><a href="<?php echo e(url('patient/view/' . $document->user_id)); ?>">
                                        <?php echo e($document->Patient->name); ?> </a></td>
                                <td class="text-center"> <?php echo e($document->document_type); ?> </td>
                                <td class="text-center">
                                    <a href="<?php echo e(url('/uploads/' . $document->file)); ?>"
                                        class="btn rounded-0  btn-primary  btn-circle btn-sm" download><i
                                            class="fa fa-eye"></i></a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/document/all.blade.php ENDPATH**/ ?>