  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          <?php $__currentLoopData = $documents;
          ...
          foreach ($__currentLoopData as $document) : $__env->incrementLoopIndices();
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="<?php echo e(url('/uploads/' . $document->file)); ?>" class="btn rounded-0  btn-primary  btn-circle btn-sm" download><i class="fa fa-eye"></i></a>
                <a href="#" class="btn rounded-0  btn-danger btn-circle btn-sm"><i class="fas fa-trash"></i></a>
              </td>
            </tr>
          <?php endforeach;
          $__env->popLoop();
