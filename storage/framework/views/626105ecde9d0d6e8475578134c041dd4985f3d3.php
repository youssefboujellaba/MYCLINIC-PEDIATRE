...
<body>
<form method="post" action="<?php echo e(route('rapport.gabarit_update')); ?>">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Nouveau template rapport </h6>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <fieldset id="fieldset4">
                            <label for=""><b>Le nome template </b></label>
                            <input type="text" class="form-control" name="name" value="<?php echo e($gabarit_titre->name); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/rapport/specialty/ophtamologie/gabarit_edit.blade.php ENDPATH**/ ?>