                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="drug" tabindex="-1" name="patient_id" aria-hidden="true">
                                <?php
                                ...
                                <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($patient->id); ?>"
                                            <?php if($user_id == $patient->id || $lastPatientId == $patient->id): ?> selected <?php endif; ?>><?php echo e($patient->name); ?></option>
                        ...
                        <input class="form-control" type="hidden" name="id_prescription" id="id_prescription" value="<?php echo e($prescription_id); ?>">
        ...
        <div class="field-group row">
            ...
            <div class="col">
                <div class="input-group mb-3">
                    <input type="number" class="form-control" placeholder="<?php echo e(__('sentence.Amount')); ?>" aria-label="Amount" aria-describedby="basic-addon1" name="invoice_amount[]" value="<?php echo e(App\Setting::get_option('montant')); ?>" required>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generalist.tayssir.cloud\resources\views/billing/create.blade.php ENDPATH**/ ?>