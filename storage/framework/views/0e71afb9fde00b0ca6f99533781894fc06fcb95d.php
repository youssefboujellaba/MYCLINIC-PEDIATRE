          ...
          <div class="card shadow mb-4">
              <div class="card-header py-3">
                  <div class="row">
                      ...
                      <div class="col-2">
                          <button type="submit" class="btn btn-success btn-sm float-right">Sauvegarde</button>
                      </div>
                  </div>
              </div>
              <div class="card-body">
...
<script type="text/template" id="fai_labels">
    <div class="field-group row">
        <div class="form-group col-md-12">
            ...
            <select type="text" name="radio_id[]" id="fai" class="form-control fai">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generalist.tayssir.cloud\resources\views/prescription/create.blade.php ENDPATH**/ ?>