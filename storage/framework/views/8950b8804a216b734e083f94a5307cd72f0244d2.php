...
<head>
    ...
    <title>Myclinic - <?php echo $__env->yieldContent('title'); ?> </title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(empty(!$lastPatientId)): ?>
                            <a href="<?php echo e(url('patient/view/'.$lastPatientId)); ?>" role="button"
                               style="position: relative ; top: 12px; right: 5px;">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright my-auto">
                        ...
                        <span style="float: right;">Pédiatre - Version <?php echo e(date('Y')); ?>V2</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
<?php /**PATH C:\wamp641\www\MYCLINIC-PEDIATRE\MYCLINIC-PEDIATRE\resources\views/layouts/specialty/pediatre/master.blade.php ENDPATH**/ ?>