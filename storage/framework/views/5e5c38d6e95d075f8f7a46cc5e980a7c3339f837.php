                                        ...
                                        <div class="row justify-content-center" style="margin-top: 20px;">
                                            <div class="col">
                                                ...
                                                foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                                    ...
                                                    <script src="<?php echo e(asset('dashboard/js/http_cdn.tiny.cloud_1_no-api-key_tinymce_6_tinymce.js')); ?>" type="text/javascript"></script>
                                                    <script>
                                                        tinymce.init({
                                                            selector: "#editor"
                                                        });
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                                ...
                                                <p style="text-align: right;"><input type="text" name="patient_cin" id="patient_cin" lang="ar" dir="rtl" style="width: 300px;" value="<?php echo e($rapport->patient_cin); ?>"> رقم البطاقة الوطنية (إن وجدة)</p>
                                    ...
                                    <div class="row mt-100" style="font-size: x-large">
                                        <div class="col" style="font-size: xx-large">
                                            ...
                                            foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                                ...
                                                <p> Nécessite la presance de sa <b><?php echo e($rapport->tuteur); ?></b> </p> Auprès de lui pendant <b> <?php echo e($rapport->nb_jour); ?></b> jours
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generaliste\generalist.tayssir.cloud\resources\views/rapport/edit.blade.php ENDPATH**/ ?>