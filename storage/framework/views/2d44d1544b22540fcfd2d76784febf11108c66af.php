<?php $__env->startSection('content'); ?>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create prescription')): ?>
                                                    <a class="btn btn-primary rounded-0 btn-sm my-4 float-right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo e(url('/uploads/' . $document->file)); ?>"
                                                                class="btn btn-primary rounded-0 btn-sm" download>
    ...
    <?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/patient/specialty/ophtamologie/view.blade.php ENDPATH**/ ?>