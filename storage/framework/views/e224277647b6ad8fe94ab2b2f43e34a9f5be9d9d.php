                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view patient')) : ?>
                            <button type="submit" class="btn rounded-0  btn-primary btn-sm float-right" style="margin-left: 15px;"><?php echo e(__('sentence.Save')); ?></button>
                            <a href="<?php echo e(route('patient.view', ['id' => $patient->id])); ?>" class="btn rounded-0  btn-primary  btn-sm float-right ">Afichier dossier patient</a>
                ...
                <form method="post" action="<?php echo e(route('patient.store_edit')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" id="Arabicname" name="nameArabic" lang="ar" dir="rtl" value="<?php echo e($patient->Patient->nameArabic); ?>">
                        </div>
                        <div class="form-group col-md-3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <label for="file-upload" class="custom-file-upload">
                                    <i class="fa fa-cloud-upload"></i> Selectionner photo...
                                </label>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" id="profession" name="profession" value="<?php echo e($patient->Patient->profession); ?>">
                            </div>
                            <div class="form-group col-md-4">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-Ophtalmologie\doctor-ophtalmologie\resources\views/patient/edit.blade.php ENDPATH**/ ?>