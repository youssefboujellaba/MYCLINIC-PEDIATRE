            ...
            <div class="row">
                ...
                <div class="col-8">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create appointment')): ?>
                        <a href="<?php echo e(route('appointment.create')); ?>" class="btn btn-primary rounded-0 btn-sm float-right"
                            style="margin-left: 15px;">
                            <i class="fa fa-plus"></i> <?php echo e(__('sentence.New Appointment')); ?>

                        </a>
                        <a href="<?php echo e(route('appointment.pending')); ?>" class="btn btn-success btn-sm float-right"
                            style="margin-left: 15px;">Salle d'attente</a>

                        <!-- Button for "Tous les rendez-vous" -->
                        <a href="<?php echo e(route('appointment.all')); ?>" class="btn btn-info btn-sm float-right"
                            style="margin-left: 15px;">
                            Tous les rendez-vous
                        </a>

                        <!-- Button for "Tous les rendez-vous de jour" -->
                        <a href="<?php echo e(route('appointment.day')); ?>" class="btn btn-warning btn-sm float-right">
                            Tous les rendez-vous de jour
                        </a>
                    <?php endif; ?>
                ...
                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">l'hours</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-success text-white" id="salle"
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/appointment/specialty/ophtamologie/pending.blade.php ENDPATH**/ ?>