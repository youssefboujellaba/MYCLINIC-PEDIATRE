                        ...
                        <div class="p-5">
                           ...
                           <form method="POST" action="<?php echo e(route('login')); ?>" class="user">
                              <div class="form-group">
                                 <input id="email" type="email" class="form-control rounded-0 shoadow-none form-control-user <?php $__errorArgs = ['email'];
                              ...
                              <div class="form-group">
                                 <input id="password" type="password" class="form-control rounded-0 shoadow-none form-control-user <?php $__errorArgs = ['password'];
                                                                                                                                    $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                                                                                                                                    if ($__bag->has($__errorArgs[0])) :
                                                                                                                                       if (isset($message)) {
                                                                                                                                          $__messageOriginal = $message;
                              ...
                              <button class="btn rounded-0  btn-warning btn-user btn-block" type="submit"> <?php echo e(__('sentence.Login')); ?></button>
                           </form>
                           <hr>
...
<?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generaliste\generalist.tayssir.cloud\resources\views/auth/login.blade.php ENDPATH**/ ?>