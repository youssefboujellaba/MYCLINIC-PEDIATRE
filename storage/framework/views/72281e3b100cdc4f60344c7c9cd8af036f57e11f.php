      ...
      <div class="col-md-4">
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               ...
               <div class="form-group">
                  <input type="submit" value="<?php echo e(__('sentence.Create Prescription')); ?>" class="btn rounded-0  btn-warning btn-block" align="center">
               </div>
            </div>
         </div>
      </div>
...
<script type="text/template" id="test_labels">
   <div class="field-group row">
                             ...
                             <div class="col-md-3">
                                 <a type="button" class="btn rounded-0  btn-danger delete text-white btn-sm" align="center"><i class='fa fa-plus'></i> <?php echo e(__('sentence.Remove')); ?></a>
