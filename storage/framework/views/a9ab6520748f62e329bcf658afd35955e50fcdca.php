...
<body class="bg-gradient-primary overflow-hidden">
    <div class="row">
        <div class="d-md-block d-none col-md-6 my-pub">
            <img src="<?php echo e(asset('img/bg__pub.jpg')); ?>" class="my-img-fluid my__img__login">
        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="copyright my-auto p-2">
                                        <p class="my-copyright text-center">Copyright &copy; Created by <a
                                                href="https://tayssir.cloud" target="_blank"> MJTech Solutions</a>
                                            <?php echo e(date('Y')); ?></p>
            ...
            <span class="my-copyright-absolute">Version : Generalist - 2023V1</span>
        </div>
...
<?php /**PATH C:\Users\Kuuhaku\Desktop\laravel\doctor-generalist.tayssir.cloud\resources\views/auth/login.blade.php ENDPATH**/ ?>