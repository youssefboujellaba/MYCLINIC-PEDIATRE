                        ...
                        <?php $__currentLoopData = $actes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="text-center">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit drug')): ?>
                                    ...
                                    <a href="#" class="btn btn-success btn-circle btn-sm edit-acte" data-acte-id="<?php echo e($acte->id); ?>" data-acte-name="<?php echo e($acte->name); ?>" data-acte-ref="<?php echo e($acte->ref); ?>" data-acte-cout="<?php echo e($acte->cout); ?>" data-acte-nums="<?php echo e($acte->nums); ?>"><i class="fa fa-edit"></i></a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit drug')): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\doctor-myclinc.tayssir.cloud\resources\views/act/create_act.blade.php ENDPATH**/ ?>