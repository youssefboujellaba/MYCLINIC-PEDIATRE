                                    ...
                                    <div class="row">
                                        ...
                                        foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p style="text-align: right;"> أنا الموقع أسفله الدكتور(ة) <strong><?php echo e($rapport->name_medcien); ?></strong></p>
                                                <p style="text-align: right;"> اشهد أنني فحصت يومه <strong> <?php echo e($rapport->verifie); ?> </strong> بطلب منه / منها </p>
                                                <p style="text-align: right;"> السيد (ة). <strong><?php echo e($rapport->patient_mariage); ?></strong></p>
                                                <p style="text-align: right;"> <input name="patient_cin" style="width: 700px; border: none; font-weight:bold;" lang="ar" dir="rtl" value="<?php echo e($rapport->patient_cin); ?>"> رقم البطاقة الوطنية (إن وجدة). </p>
                                                ...
                                                <textarea class="form-control" name="conclusion" id="conclusion" rows="5" lang="ar" dir="rtl" value="<?php echo e($rapport->conclusion); ?>" disabled><?php echo e($rapport->conclusion); ?></textarea> <br>
                                                <b>
                                    ...
                                    <div class="row justify-content-center" style="margin-top: 100px;">
                                        <div class="col">
                                            ...
                                            foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                                Que l'état de santé de l'enfant <strong><?php echo e($rapport->child); ?></strong> <br> <br>
                                                Nécessite la presance de <b><?php echo e($rapport->tuteur); ?></b> Aupres de lui pendant <b> <?php echo e($rapport->nb_jour1); ?></b> jours
                                                à partir du <b><?php echo e($rapport->date_debut); ?></b>
                                            <?php endforeach;
                                            $__env->popLoop();
                                            $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-center" style="margin-top: 100px;">
                                        <div class="col">
                                            ...
                                            foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                                <?php echo nl2br(e($rapport->libre)); ?>
                    ...
                    <div class="row justify-content">
                        <div class="col-12">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col text"><br><br><br><br><br><br>
                                        <br><br><br><br><br><br>
                                    </div>
                                </div><br><br><br><br>
                                <div class="row mt-100" style="font-size: x-large">
                                    <div class="col">
                                        ...
                                        foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                            $loop = $__env->getLastLoop(); ?>
                                            <p style="font-size: xx-large"> <?php echo nl2br(e($rapport->libre)); ?></p>
                                        <?php endforeach;
                                        $__env->popLoop();
                                        $loop = $__env->getLastLoop(); ?>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-100" style="font-size: x-large">
                                    <div class="col" style="font-size: xx-large">
                                        ...
                                        foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                            $loop = $__env->getLastLoop(); ?>
                                            <p> Que l'enfant <strong><?php echo e($rapport->child); ?></strong></p> <br> est en bonne santé
                                            et peut intègrer la crèche sans aucun soucis
                                        <?php endforeach;
                                        $__env->popLoop();
                                        $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-100" style="font-size: x-large">
                                    <div class="col" style="font-size: xx-large">
                                        ...
                                        foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                            $loop = $__env->getLastLoop(); ?>
                                            <p>Que l'état de santé de l'enfant <strong><?php echo e($rapport->child); ?></strong> </p> <br>
                                            <p> Nécessite la presance de <b><?php echo e($rapport->tuteur); ?></b> </p> <br> aupres de lui pendant <b> <?php echo e($rapport->nb_jour1); ?></b> jours
                                            à partir du <b><?php echo e($rapport->date_debut); ?></b>
                                        <?php endforeach;
                                        $__env->popLoop();
                                        $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row">
                                    ...
                                    foreach ($__currentLoopData as $rapport) : $__env->incrementLoopIndices();
                                        ...
                                        <div class="form-group" style="font-size: x-large;">
                                            ...
                                            <h1 style="text-align: center;">شهادة طبية خاصة بإبرام عقد الزواج</h1> <br>
                                            <p style="text-align: right;"> أنا الموقع أسفله الدكتور(ة) <strong><?php echo e($rapport->name_medcien); ?></strong></p> <br>
                                            <p style="text-align: right;"> اشهد أنني فحصت يومه <strong> <?php echo e($rapport->verifie); ?> </strong> بطلب منه / منها </p> <br>
                                            <p style="text-align: right;"> السيد (ة). <strong><?php echo e($rapport->patient_mariage); ?></strong></p> <br>
                                            <p style="text-align: right;"> <input name="patient_cin" style="width: 700px; border: none; font-weight:bold;" lang="ar" dir="rtl" value="<?php echo e($rapport->patient_cin); ?>"> رقم البطاقة الوطنية (إن وجدة). </p> <br>
                                            <p style="text-align: right;">وتبين بعد الفحص السريري أن المعني (ة) بالأمر لا تظهر عليه (ا) أية علامة لمرض ما</p> <br>
                                            <b>
                                                <p style="text-align: right;">استنتاجات الطبيب</p>
                                            </b> <br>
                                            <p style="text-align: right;" dir="ltr"><?php echo nl2br(e($rapport->conclusion)); ?></p><br>
                                            <b>
                                                <p style="text-align: right;">وسلمت هذه الشهادة للمعني بالأمر للإدلاء بها قصد الزواج</p>
                                            </b>
                                            <p style="text-align: right;"></p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\doctor\generalist\generalist.tayssir.cloud\resources\views/rapport/view.blade.php ENDPATH**/ ?>