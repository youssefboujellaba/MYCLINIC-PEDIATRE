...
<?php $__env->startSection('content'); ?>
    ...
    <a href="<?php echo e(url('prescription/edit/'.$prescription->id)); ?>" class="btn btn-success" style="margin-right:20px;">Modifier</a>
    <a href="<?php echo e(route('prescription.create')); ?>" class="btn btn-primary" style="margin-right:20px;"><?php echo e(__('sentence.New Prescription')); ?></a>
    <a href="<?php echo e(route('prescription.all')); ?>" class="btn btn-warning" style="margin-right:20px;"><?php echo e(__('sentence.All Prescriptions')); ?></a>
</div>
<br>
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-400">
                        <div class="col">
                            ...
                            <?php if(isset($prescription->User->Patient->cin)): ?> <p class="text-left">Mr,Mme  : <strong> <?php echo e($prescription->User->name); ?></strong> porteur cin <strong><?php echo e($prescription->User->Patient->cin); ?></strong></p><br><?php endif; ?>
                            ...
                            <p class="text-left">Le :  <strong><?php echo e(\Carbon\Carbon::parse($prescription->dated)->format('d-m-Y')); ?>   </strong> sauf complication(s) </p> <?php endif; ?>
                            <?php if($prescription->certificat != 1): ?>  
                            <p class="text-left">A partir du :  <strong><?php echo e(\Carbon\Carbon::parse($prescription->dated)->format('d-m-Y')); ?> </strong> au <strong> <?php echo e(\Carbon\Carbon::parse($prescription->datef)->format('d-m-Y')); ?></strong>  sauf complication(s) </p> <?php endif; ?>
                            <br>
            ...
            <div class="row justify-content-center" style="font-size: xx-large">
                <div class="col" >
                   <strong style="margin-left: 100px;"><u>Faire SVP : </u></strong><br><br>
                    <?php $__currentLoopData = $prescription_radios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $radio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <b> <li style="margin-left: 120px;"><?php if(empty(!$radio->radio_name)): ?> <?php echo e($radio->radio_name); ?> <?php endif; ?></li></b>
                        <?php if(empty(!$radio->justif)): ?>  <p style="margin-left: 170px;" > <?php echo nl2br(e( $radio->justif )); ?> </p> <?php endif; ?>
                        <br>
                        <?php if($loop->last): ?>
                            <br>
                            <div style="margin-bottom: 40px;">
        ...
        <br>
            <div class="row" style="font-size: xx-large ; margin-left: 25px; margin-right: 25px;">
                <div class="col">
                    <?php $__currentLoopData = $prescription_drugs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><?php echo e($drug->Drug->trade_name); ?> <?php echo e($drug->strength); ?><br>
                            <?php if(isset($drug->drug_advice)): ?> <strong><p  style="font-size: xx-large; margin-left: 120px; margin-right: 25px;"> <?php echo e($drug->drug_advice); ?></p></strong></li> <?php endif; ?>
                        <?php if($loop->last): ?>
...
<br>
             ...
             <?php if(count($prescription_tests) > 0): ?>
                         ...
                         <div class="row justify-content-center">
                             <div class="col">
                                 <strong><u style="font-size: xx-large; margin-left: 25px; margin-right: 25px;">Faire SVP :</u></strong><br><br>
                                 <?php $__currentLoopData = $prescription_tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generalist.tayssir.cloud\resources\views/prescription/view.blade.php ENDPATH**/ ?>