    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-4">
                    <a href="<?php echo e(route('rapport.create')); ?>" class="btn btn-primary rounded-0 btn-sm float-right"><i
...
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/rapport/specialty/ophtamologie/all.blade.php ENDPATH**/ ?>