                ...
                <?php if(Auth::user()->can('create drug') ||
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapserapport" class="collapse" aria-labelledby="headingPages"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create drug')): ?>
                                    <a class="collapse-item" href="<?php echo e(route('rapport.create')); ?>">Ajoute Rapport</a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all drugs')): ?>
                                ...
                                <?php if(empty(!$lastPatientId)): ?>
                                    <a href="<?php echo e(url('patient/view/' . $lastPatientId)); ?>" role="button">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                <center><img src="<?php echo e(asset('img/girll.png')); ?>" width="50"
                                                        height="50" class="d-none d-sm-inline-block rounded-circle mr-2">
                                                </center>
                                            <?php endif; ?>

                                        <?php endif; ?>
                                        <?php echo e($genderPation . 'sdadsa'); ?>
                ...
                <footer class="sticky-footer bg-white">
                    <div class=" my-auto px-4">
                        <div class="copyright my-auto">
                            ...
                            <span style="float: right;">Version : Pédiatre - 2023V1
                            </span>
                        </div>
                    </div>
                </footer>
...
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/layouts/specialty/pediatre/master.blade.php ENDPATH**/ ?>