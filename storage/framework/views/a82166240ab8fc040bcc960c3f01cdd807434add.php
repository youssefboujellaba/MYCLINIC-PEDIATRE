        ...
        <div class="col-md-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <input type="submit" value="<?php echo e(__('sentence.Edit Prescription')); ?>" class="btn rounded-0  btn-warning btn-block" align="center">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="repeatable">
                            ...
                            foreach ($__currentLoopData as $prescription_test) : $__env->incrementLoopIndices();
                                ...
                                <div class="field-group row">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control rounded-0 shoadow-none multiselect-doctorino" name="test_name[]" id="test" tabindex="-1" aria-hidden="true" required>
