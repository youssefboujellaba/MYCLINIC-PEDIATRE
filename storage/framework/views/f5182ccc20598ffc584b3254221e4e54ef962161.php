        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th class='xs__screen'><?php echo e(__('sentence.Reference')); ?></th>
                            <th><?php echo e(__('sentence.Patient')); ?></th>
                            <th class="xxs__screen"><?php echo e(__('sentence.Date')); ?></th>
                            <th class="text-center"><?php echo e(__('sentence.Amount')); ?> - <font class="text-danger">Due Balance
                                </font>
                            </th>
                            <th class="text-center"><?php echo e(__('sentence.Status')); ?></th>
                            <th class="text-center xxs__screen"><?php echo e(__('sentence.Payment Method')); ?></th>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="xs__screen"><?php echo e($invoice->reference); ?></td>
                                <td><a href="<?php echo e(url('patient/view/' . $invoice->user_id)); ?>"> <?php echo e($invoice->User->name); ?>

                                    </a></td>
                                <td class="xxs__screen"><?php echo e($invoice->created_at->format('d M Y')); ?></td>
                                ...
                                <td class="text-center xxs__screen"><label class="badge badge-primary-soft"><i
...
<?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/billing/specialty/ophtamologie/all.blade.php ENDPATH**/ ?>