            ...
            <div class="row">
                ...
                <div class="col-4">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create assurance')): ?>
                        <a href="<?php echo e(route('assurance.create')); ?>" class="btn   btn-primary btn-sm float-right"><i
                                class="fa fa-plus"></i> <?php echo e(__('sentence.Add assurance')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit drug')): ?>
                                        <a href="<?php echo e(url('assurance/edit/' . $assurance->id)); ?>"
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete drug')): ?>
                                        <a class="btn rounded-0  btn-outline-danger btn-circle btn-sm" data-toggle="modal"
                                            ...
                                            data-link="<?php echo e(url('assurance/delete/' . $assurance->id)); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kuuhaku\Desktop\laravel\doctor-generalist.tayssir.cloud\resources\views/assurance/all.blade.php ENDPATH**/ ?>