        ...
        <div id="wrapper">
                        ...
                        <div id="collapseGraph" class="collapse" aria-labelledby="headingPages"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create drug')): ?>
                                    <a class="collapse-item"
                                        href="<?php echo e(route('graph.create')); ?>"><?php echo e(__('sentence.Add graph')); ?></a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all drugs')): ?>
                                    <a class="collapse-item"
                                        href="<?php echo e(route('graph.all')); ?>"><?php echo e(__('sentence.All graph')); ?></a>
                                <?php endif; ?>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseSettings" class="collapse" aria-labelledby="headingPages"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <!--Radio-->
                                <div class="dropdown">
                                    <a class="collapse-item dropdown-toggle" href="#" id="nestedDropdown4"
                                        role="button" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                        Radio
                                    </a>
                                ...
                                <!-- Nested Dropdown 2 -->
                                <div class="dropdown">
                                    <a class="collapse-item dropdown-toggle" href="#" id="nestedDropdown2"
                                        role="button" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                        Analyse
                                    </a>
                                ...
                                <!-- Nested Dropdown 3 -->
                                <div class="dropdown">
                                    <a class="collapse-item dropdown-toggle" href="#" id="nestedDropdown3"
                                        role="button" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    <!-- Topbar -->
                    <nav
                        class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow d-flex justify-content-between">
                        ...
                        <div class="dropdown shortcut-menu mr-4">
                            <button type="button"
                                class="btn btn-doctorino brd-20 rounded-0 shadow-none dropdown-toggle"
                                data-toggle="dropdown" aria-expanded="false">
                                <i class="fa fa-plus"></i>
                                <span class="md__screen"> <?php echo e(__('sentence.Create as new')); ?> </span></button>
                            <div class="dropdown-menu shadow">
                                ...
                                <?php if(Auth::user()->can('create diagnostic test')): ?>
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('test.create')); ?>"><?php echo e(__('sentence.Diagnosis Test')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all patients')): ?>
                            <form class="d-none d-lg-inline-block form-inline w-100   my-2 my-md-0 mr-5  navbar-search"
                                action="<?php echo e(route('patient.search')); ?>" method="post">
                                <div class="input-group">
                                    <input type="text" class="form-control bg-light border-0 small"
                                        placeholder="Rechercher Patients ..." aria-label="Search"
                                        aria-describedby="basic-addon2" name="term">
                                    <?php echo csrf_field(); ?>
                                    <div class="input-group-append">
                                        <button class="btn bg-gradient-primary text-light" type="submit">
                                            <i class="fas fa-search fa-sm"></i>
                                        </button>
                                    </div>
                                </div>
                            </form>
                            <div class="d-md-none mr-2 mr-sm-5">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn bg-gradient-primary text-light" data-toggle="modal"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Rechercher Patients</h5>
                                            ...
                                            <div class="modal-body">
                                                <form class=" w-100  navbar-search"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <?php echo csrf_field(); ?>
                                                        <div class="input-group-append">
                                                            <button class="btn bg-gradient-primary text-light"
                                                                type="submit">
                                                                <i class="fas fa-search fa-sm"></i>
                                                            </button>
                                                        </div>
                                ...
                                <?php if(empty(!$lastPatientId)): ?>
                                    <a href="<?php echo e(url('patient/view/' . $lastPatientId)); ?>" role="button">
                                        <?php if(empty(!$imagePatient)): ?>
                                            <center><img src="<?php echo e(asset('uploads/' . $imagePatient)); ?>" width="50"
                                                    height="50" class="d-none d-sm-inline-block rounded-circle mr-2">
                                            </center>
                                        <?php else: ?>
                                            <?php if($genderPation == 'Garçon' || $genderPation == 'Boy'): ?>
                                                <center><img src="<?php echo e(asset('img/boy.jpg')); ?>" width="50" height="50"
                                                        class="d-none d-sm-inline-block mr-2 rounded-circle">
                                                </center>
                                            <?php elseif($genderPation == 'Male' || $genderPation == 'Homme'): ?>
                                                <center><img src="<?php echo e(asset('img/man.png')); ?>" width="50" height="50"
                                                        class="d-none d-sm-inline-block mr-2 rounded-circle">
                                                </center>
                                            <?php elseif($genderPation == 'Famme' || $genderPation == 'Female'): ?>
                                                <center><img src="<?php echo e(asset('img/woman.png')); ?>" width="50"
                                                        height="50" class="d-none d-sm-inline-block mr-2 rounded-circle">
                                                </center>
                                            <?php else: ?>
                                                <center><img src="<?php echo e(asset('img/girl.png')); ?>" width="50" height="50"
                                                        class="d-none d-sm-inline-block mr-2 rounded-circle">
                                                </center>
                                            <?php endif; ?>
                                    ...
                                    <a href="<?php echo e(url('patient/view/' . $lastPatientId)); ?>" role="button">
                                        <span><?php echo e($namePatient); ?></span>
                                    </a>
                                    <!-- Nav Item - User Information -->
                                    <a class="fa fa-user-times fa-1x text-danger ml-2"
                                        href="<?php echo e(route('patient.create')); ?>" aria-hidden="true"></a>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="nav-item dropdown no-arrow ">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-2 d-none d-lg-inline-block text-gray-900 small-600"><?php echo e(Auth::user()->name); ?></span>
                ...
                <footer class="sticky-footer bg-white">
                    <div class="px-5 my-auto">
                        <div class="copyright my-auto">
                            <span>Copyright &copy; Created by <a href="https://tayssir.cloud" target="_blank"> MJTech
                                    Solutions</a> <?php echo e(date('Y')); ?></span>
                            <span style="float: right;">Version : Generalist - 2023V1</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn rounded-0  btn-primary" href="<?php echo e(route('logout')); ?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn rounded-0  btn-secondary" type="button"
                        data-dismiss="modal"><?php echo e(__('sentence.Cancel')); ?></button>
                    <a class="btn rounded-0  btn-danger" id="delete_link"><?php echo e(__('sentence.Delete')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\Kuuhaku\Desktop\laravel\doctor-generalist.tayssir.cloud\resources\views/layouts/master.blade.php ENDPATH**/ ?>