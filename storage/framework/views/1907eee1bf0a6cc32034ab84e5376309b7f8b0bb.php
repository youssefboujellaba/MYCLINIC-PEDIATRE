 ...
 <div id="print_area" style="display: none;">
     ...
     <br><br><br><br>
                                 <div class="row">
                                    ...
                                    <div class="col-3" style="font-size: x-large">
                                       <p class="text-left" style="position: relative ;left: 900px;"><b>Skhirat ,le :</b> <?php echo e($billing->created_at->format('d-m-Y')); ?>
                                 ...
                                 <div class="row justify-content-center">
                                    <div class="col">
                                       ...
                                       <h5 class="text-center mt-5" style="font-size: x-large"><b><?php echo e(__('sentence.Invoice')); ?></b></h5>
                                       <br><br>
                                       <table class="table" style="font-size: xx-large">
                                          <tr >
                                             <td width="10%"><b>#</b></td>
                                             <td width="60%"><b>Elément</b></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor\resources\views/billing/view.blade.php ENDPATH**/ ?>