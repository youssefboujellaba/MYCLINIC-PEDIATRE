      ...
      <div class="card shadow mb-4">
         <div class="card-header py-3">
             <div class="row">
                 ...
                 <div class="col-4">
                     <button type="submit" class="btn btn-success btn-sm float-right" style="margin-left: 15px;"><?php echo e(__('sentence.Save')); ?></button>
                     <a href="<?php echo e(route('patient.all')); ?>" class="btn btn-warning btn-sm float-right ">Tous les patinets</a>
                 </div>
             </div>
         </div>
         <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\GitHub\doctor-generalist.tayssir.cloud\resources\views/patient/create.blade.php ENDPATH**/ ?>