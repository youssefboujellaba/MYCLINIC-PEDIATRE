                                        ...
                                        <div class="form-group">
                                            <?php $__currentLoopData = $rapports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rapport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <textarea name="conclusion" id="" lang="ar" dir="rtl" rows="5" class="form-control"
                                                    disabled><?php echo e($rapport->conclusion); ?></textarea>
                                                <b>
                                                    ...
                                                    <div class="col"
                                                        ...
                                                        <p>
                                                            <b style="float: right;"><?php echo e(App\Setting::get_option('ville')); ?>
                                                                ...
                                                                ,le <?php echo e($rapport->created_at->format('d-m-Y')); ?> </b>
                                                        </p>
                                                        <br>
                                                    </div>
                                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col text">
                                            ...
                                            <div class="header">
                                                <div class="row justify-content-center">
                                                    <img src="<?php echo e(asset('img/minister.png')); ?>"
                                        ...
                                        <div class="col" style="font-size: x-large">
                                            <?php $__currentLoopData = $rapports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rapport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <p style="text-align: right;">
                                                    <b><label><?php echo e(App\Setting::get_option('nomearabic')); ?></label></b> أنا
                                                    الموقع أسفله الدكتور(ة) </p> <br>
                                                <p style="text-align: right;"> اشهد أنني فحصت يومه
                                                    <b><label><?php echo e($rapport->verifie); ?></label></b> بطلب منه / منها </p> <br>
                                                <p style="text-align: right;">
                                                    <b><label><?php echo e($rapport->patient_mariage); ?></label></b> السيد (ة)</p>
                                                <br>
                                                <p style="text-align: right;">
                                                    <b><label><?php echo e($rapport->patient_cin); ?></label></b> رقم البطاقة الوطنية
                                                    (إن وجدة)</p> <br>
                                                <p style="text-align: right;">وتبين بعد الفحص السريري أن المعني (ة) بالأمر
                                                ...
                                                <p style="text-align: right;" dir="rtl"><?php echo nl2br(e($rapport->conclusion)); ?></p>
                                                <br>
                                                <b>
                                                    <p style="text-align: right;">وسلمت هذه الشهادة للمعني بالأمر للإدلاء
                                                        بها قصد الزواج</p>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/rapport/specialty/generalist/view.blade.php ENDPATH**/ ?>