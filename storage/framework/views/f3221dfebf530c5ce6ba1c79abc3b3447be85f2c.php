<?php $__env->startSection('content'); ?>
            ...
            <div class="col-10">
                <div class="card shadow mb-4">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button href=""
                            class=" d-sm-inline-block btn rounded-0 btn-sm btn-info shadow-sm print_prescription"><i
    ...
    <?php if(count($radios_pediatre) > 0): ?>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"></h1>
    </div>
    <div id="print_radioo">
            ...
            <div class="col-10">
                <div class="card shadow mb-4">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button href=""
                            class=" d-sm-inline-block btn rounded-0 btn-sm btn-info shadow-sm print_radio"><i
                                class="fas fa-print fa-sm text-white-50"></i>
                            <span class="d-none d-md-inline-block">Imprimer</span>
                        </button>
                    </div>
                        ...
                        <?php if(count($radios_pediatre) > 0): ?>
                            ...
                            <div class="row justify-content-center">
                                <div class="col px-2">
                                    ...
                                    <ol>
                                        <?php $__currentLoopData = $radios_pediatre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $radio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <?php if(empty(!$radio->radio)): ?>
                                                    <?php echo e($radio->radio); ?>
                ...
                <div class="col-10">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <br><br>
                            <button href=""
                                class=" d-sm-inline-block btn rounded-0 btn-sm btn-info shadow-sm print_certi"
    ...
    <div id="print_radio" style="display: none;">
        ...
        <div class="row">
            <div class="col" style="font-size: xx-large; margin-left: 25px; margin-right: 25px; text-align: center;">
                <br> <br>
                <p>
                    <b><span style="float: right;"><?php echo e(App\Setting::get_option('ville')); ?>, <?php echo e(__('sentence.On')); ?>: <?php echo e($prescription->created_at->format('d-m-Y')); ?></span></b>
                </p>
                <br>
                <div style="display: block; margin: 0 auto; width: fit-content;">
                    <b><?php echo e($prescription->User->name); ?></b>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/prescription/specialty/pediatre/view.blade.php ENDPATH**/ ?>