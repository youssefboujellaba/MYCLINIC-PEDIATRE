        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <input type="submit" value="Créer le Graph" class="btn btn-success" align="right" style=";position: absolute; right: 30px; top: 8px;">
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\doctor-generalist.tayssir.cloud\resources\views/graph/create.blade.php ENDPATH**/ ?>