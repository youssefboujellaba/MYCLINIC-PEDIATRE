                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Saturday"
                                    name="saturday_from" value="<?php echo e(App\Setting::get_option('saturday_from')); ?>">
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Saturday"
                                    name="saturday_to" value="<?php echo e(App\Setting::get_option('saturday_to')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Sunday"
                                class="col-sm-4 col-md-3 col-form-label"><?php echo e(__('sentence.Sunday')); ?></label>
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Sunday"
                                    name="sunday_from" value="<?php echo e(App\Setting::get_option('sunday_from')); ?>">
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Sunday"
                                    name="sunday_to" value="<?php echo e(App\Setting::get_option('sunday_to')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Monday"
                            ...
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Monday"
                                    name="monday_from" value="<?php echo e(App\Setting::get_option('monday_from')); ?>">
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Monday"
                                    name="monday_to" value="<?php echo e(App\Setting::get_option('monday_to')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Tuesday"
                            ...
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Tuesday"
                                    name="tuesday_from" value="<?php echo e(App\Setting::get_option('tuesday_from')); ?>">
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Tuesday"
                                    name="tuesday_to" value="<?php echo e(App\Setting::get_option('tuesday_to')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Wednseday"
                            ...
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Wednseday"
                                    name="wednesday_from" value="<?php echo e(App\Setting::get_option('wednesday_from')); ?>">
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Wednseday"
                                    name="wednesday_to" value="<?php echo e(App\Setting::get_option('wednesday_to')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Thurday"
                            ...
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Thurday"
                                    name="thursday_from" value="<?php echo e(App\Setting::get_option('thursday_from')); ?>">
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Thurday"
                                    name="thursday_to" value="<?php echo e(App\Setting::get_option('thursday_to')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Friday"
                            ...
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Friday"
                                    name="friday_from" value="<?php echo e(App\Setting::get_option('friday_from')); ?>">
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <input type="time" class="form-control rounded-0 shadow-none " id="Friday"
                                    name="friday_to" value="<?php echo e(App\Setting::get_option('friday_to')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-9">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kuuhaku\Desktop\laravel\doctor-generalist.tayssir.cloud\resources\views/settings/doctorino_settings.blade.php ENDPATH**/ ?>