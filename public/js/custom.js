    ...
    $(document).ready(function() {
        $(".drugs_labels .repeatable").repeatable({
            ...
            afterAdd: function () {
                ...
                $(".multiselect-drug").on("change", function () {
                    var selectedOption = $(this).find("option:selected");
                    var remarque = selectedOption.data("remarque");
                    // Find the corresponding input element within the same row
                    var remarqueinpute = $(this).closest(".field-group.row").find("#drug_advice");
                    remarqueinpute.val(remarque);
                });
