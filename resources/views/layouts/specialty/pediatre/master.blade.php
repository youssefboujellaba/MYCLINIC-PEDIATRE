                ...
                <li class="nav-item">
                    ...
                    <div id="collapserapport" class="collapse" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            {{--                            @can('view all drugs')--}}
                            {{--                                <a class="collapse-item" href="{{ route('gabarit.all') }}">Tout les rapports</a>--}}
                            {{--                            @endcan--}}
                            {{--                            @can('view all drugs')--}}
                            {{--                                <a class="collapse-item" href="{{ route('gabarit.gabarit_all') }}">Template rapport </a>--}}
                            {{--                            @endcan--}}
                        </div>
                    </div>
                </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright my-auto">
                        ...
                        <span style="float: right;">Pédiatre - Version {{ date('Y') }}V2</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
