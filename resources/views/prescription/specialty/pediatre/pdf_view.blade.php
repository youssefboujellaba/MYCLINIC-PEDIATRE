...
<head>
    ...
    <title>Tayssir - {{ __('sentence.View Prescription') }}
    </title>
        ...
        <div class="col">
            ...
            <p>
                ...
                @isset($prescription->User->Patient->birthday)
                    ...
                    ({{ \Carbon\Carbon::parse($prescription->User->Patient->birthday)->age }} {{ __('sentence.Years') }})
                @endisset
    ...
    <div class="row justify-content-center">
        <div class="col">
            @forelse ($prescription_drugs as $drug)
                <li>{{ $drug->type }} - {{ $drug->Drug->trade_name }} {{ $drug->strength }} - {{ $drug->dose }}
