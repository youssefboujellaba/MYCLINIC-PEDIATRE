                        ...
                        @if (count($radios_pediatre) > 0)
                            ...
                            <div class="row justify-content-center">
                                <div class="col px-2">
                                    ...
                                    <ol>
                                        @foreach ($radios_pediatre as $radio)
                                            <li>
                                                @empty(!$radio->radio)
                                                    {{ $radio->radio }}
                                                @endempty
    ...
    <div id="print_radio" style="display: none;">
        ...
        <div class="row">
            <div class="col" style="font-size: xx-large; margin-left: 25px; margin-right: 25px; text-align: center;">
                <br> <br>
                <p>
                    <b><span style="float: right;">{{ App\Setting::get_option('ville') }}, {{ __('sentence.On') }}: {{ $prescription->created_at->format('d-m-Y') }}</span></b>
                </p>
                <br>
                <div style="display: block; margin: 0 auto; width: fit-content;">
                    <b>{{ $prescription->User->name }}</b>
                </div>
            </div>
