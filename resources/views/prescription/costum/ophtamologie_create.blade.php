@section('content')
    <form method="post" action="{{ route('prescription.store') }}" id="form_id">
...
@section('footer')
    ...
    {{--        // Add a submit event listener to the form containing the select --}}
    {{--        document.getElementById("form_id").addEventListener("submit", function(event) { --}}
    {{--            // Check if the selected option has a null value --}}
