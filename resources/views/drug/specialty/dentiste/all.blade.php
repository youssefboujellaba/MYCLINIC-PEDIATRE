    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row mb-2">
                ...
                <div class="col-6">
                    @can('create drug')
                        <a href="{{ route('drug.create') }}" class="btn rounded-0  btn-primary btn-sm float-right"><i
            ...
            <div class="row">
                <div class="col-12">
                    <form class=" d-block form-inline mr-auto navbar-search" action="{{ route('drug.search') }}"
                        method="post">
