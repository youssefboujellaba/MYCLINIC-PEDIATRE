    ...
    <body>
        <form method="post" action="{{ route('rapport.update') }}">
            <div class="row justify-content-center">
                ...
                <div class="col-md-8">
                    <input type="submit" value="Enregistrer" class="btn rounded-0  btn-primary "
                                            ...
                                            <div class="row justify-content-center" style="margin-top: 100px;">
                                                <div class="col">
                                                    ...
                                                    @foreach ($rapports as $rapport)
                                                        ...
                                                        Que l'état de santé de <strong><input type="text"
                                            ...
                                            <div class="form-group">
                                                @foreach ($rapports as $rapport)
                                                    ...
                                                    <p style="text-align: right;"><input type="text"
                                                            name="name_medcien" id="name_medcien"
                                                            value="{{ App\Setting::get_option('nomearabic') }}"
                                                            lang="ar" dir="rtl"
                                                            style="width: 200px; border: none; font-weight:bold;"
                                                            disabled>أنا الموقع أسفله الدكتور(ة) </p>
                                                    <p style="text-align: right;">اشهد أنني فحصت يومه <input
                                                            type="text" name="verifie" id="verifie" lang="ar"
                                                            dir="rtl" style="width: 345px;"
                                                            value="{{ $rapport->verifie }}"> بطلب منه / منها</p>
                                                    <p style="text-align: right;"><input type="text"
                                                            name="patient_mariage" id="patient_mariage" lang="ar"
                                                            dir="rtl" style="width: 435px;"
                                                            value="{{ $rapport->patient_mariage }}"> السيد (ة)</p>
                                                    <p style="text-align: right;"><input type="text"
                                                            name="patient_cin" id="patient_cin" lang="ar"
                                                            dir="rtl" style="width: 300px;"
                                                            value="{{ $rapport->patient_cin }}"> رقم البطاقة الوطنية (إن
                                                        وجدة)</p>
                                                    ...
                                                    <textarea name="conclusion" id="" lang="ar" dir="rtl" rows="5"
                                                        value="{{ $rapport->conclusion }}" class="form-control rounded-0 shadow-none ">{{ $rapport->conclusion }}</textarea>
                                                    <b>
