                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="col" style="font-size: large; margin-left: 25px; margin-right: 25px;">
                                        <p style="float: right;">{{ App\Setting::get_option('ville') }} ,{{ __('sentence.On') }} :{{ $rapport->created_at->format('d-m-Y')}}</p>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-center" style="margin-top: 100px;">
                                        <div class="col" >
                                            ...
                                            @foreach($rapports as $rapport)
                                            Que l'état de santé de  <strong>{{ $rapport->child }}</strong> <br> <br>
                                            Nécessite la présence de  <b>{{$rapport->tuteur}}</b>  Auprès de lui pendant <b> {{$rapport->nb_jour1}}</b> jours
                                            à partir du <b>{{$rapport->date_debut}}</b>
                                            @endforeach
                                            <br><br>
                                            <br>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p style="text-align: right;"><input type="text" name="name_medcien" id="name_medcien" value="{{ App\Setting::get_option('nomearabic') }}" lang="ar" dir="rtl" style="width: 200px; border: none; font-weight:bold;" disabled>أنا الموقع أسفله الدكتور(ة) </p>
                                            <p style="text-align: right;">اشهد أنني فحصت يومه <input type="text" name="verifie" id="verifie" lang="ar" dir="rtl" style="width: 345px;" value="{{$rapport->verifie}}" disabled> بطلب منه / منها</p>
                                            <p style="text-align: right;"><input type="text" name="patient_mariage" id="patient_mariage" lang="ar" dir="rtl" style="width: 435px;" value="{{$rapport->patient_mariage }}" disabled>  السيد (ة)</p>
                                            <p style="text-align: right;"><input type="text" name="patient_cin" id="patient_cin" lang="ar" dir="rtl" style="width: 300px;" value="{{$rapport->patient_cin}}" disabled>  رقم البطاقة الوطنية (إن وجدة)</p>
                                            ...
                                            <textarea name="conclusion" id="" lang="ar" dir="rtl" rows="5" class="form-control" disabled>{{$rapport->conclusion}}</textarea>
                                    ...
                                    <div class="col text">
                                        ...
                                        <div class="row">
                                            <div class="col" style="font-size: xx-large; margin-left: 25px; margin-right: 25px;">
                                                <p>
                                                    <b style="float: right;">{{ App\Setting::get_option('ville') }} ,le {{$rapport->created_at->format('d-m-Y')}}  </b>
                                                </p>
                                                <br>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col text">
                                        ...
                                        <div class="row">
                                            <div class="col" style="font-size: xx-large; margin-left: 25px; margin-right: 25px;">
                                                <p>
                                                    <b style="float: right;">{{ App\Setting::get_option('ville') }} ,{{ __('sentence.On') }} : {{ $rapport->created_at->format('d-m-Y') }}</b>
                                                </p>
                                                <br>
                                            </div>
                                        </div>
                                ...
                                <div class="row mt-100" style="font-size: x-large">
                                    <div class="col" style="font-size: xx-large">
                                        ...
                                        @foreach($rapports as $rapport)
                                           ...
                                           <p> Nécessite la présence de  <b>{{$rapport->tuteur}}</b> </p> <br> Auprès de lui pendant <b> {{$rapport->nb_jour1}}</b> jours
                                            à partir du <b>{{$rapport->date_debut}}</b>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col text">
                                        ...
                                        <div class="header">
                                            <div class="row justify-content-center">
                                                <img src="{{ asset('img/minister.png') }}" style="width: 200px; height: 200px;">
                                            </div>
                                ...
                                <div class="row mt-100" style="font-size: x-large">
                                    <div class="col" style="font-size: x-large">
                                        @foreach($rapports as $rapport)
                                            <p style="text-align: right;"> <b><label>{{ App\Setting::get_option('nomearabic') }}</label></b> أنا الموقع أسفله الدكتور(ة)  </p> <br>
                                            <p style="text-align: right;"> اشهد أنني فحصت يومه  <b><label>{{ $rapport->verifie }}</label></b> بطلب منه / منها  </p> <br>
                                            <p style="text-align: right;"><b><label>{{ $rapport->patient_mariage }}</label></b>  السيد (ة)</p> <br>
                                            <p style="text-align: right;"><b><label>{{ $rapport->patient_cin }}</label></b>  رقم البطاقة الوطنية (إن وجدة)</p> <br>
                                            <p style="text-align: right;">وتبين بعد الفحص السريري أن المعني (ة) بالأمر لا تظهر عليه (ا) أية علامة لمرض ما</p> <br>
                                            <b><p style="text-align: right">:استنتاجات الطبيب</p></b> <br>
                                            <p style="text-align: right;" dir="rtl">{!! nl2br(e($rapport->conclusion)) !!}</p><br>
                                            <b><p style="text-align: right;">وسلمت هذه الشهادة للمعني بالأمر للإدلاء بها قصد الزواج</p></b>
                                        @endforeach
                                    </div>
                                </div>
