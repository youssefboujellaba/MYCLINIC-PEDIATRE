                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <h4 class="text-center"><b>{{ $patient->name }}</b> <label class="badge badge-primary-soft"> <a
                                        href="{{ url('patient/edit/' . $patient->id) }}"><i
                                            class="fa fa-pen"></i></a></label>
                            </h4>
                            <hr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a href="{{ url('prescription/pdf/' . $prescription->id) }}"
                                                        class="btn rounded-0  btn-outline-primary btn-circle btn-sm"><i
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <a href="{{ url('/uploads/' . $document->file) }}"
                                                            class="btn rounded-0  btn-primary btn-sm" download><i
