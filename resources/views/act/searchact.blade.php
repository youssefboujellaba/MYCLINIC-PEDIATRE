                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @can('edit drug')
                                ...
                                <a href="#" class="btn btn-success btn-circle btn-sm edit-acte" data-acte-id="{{ $acte->id }}" data-acte-name="{{ $acte->name }}" data-acte-ref="{{$acte->ref}}" data-acte-cout="{{$acte->cout}}"><i class="fa fa-edit"></i></a>
                            @endcan
                            @can('edit drug')
