                ...
                <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <a href="{{ route('patient.all') }}"
                                    class="btn btn-secondary rounded-0 btn-sm float-right ">Tous
                                    les patinets</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            {{--                     <input type="text" class="form-control rounded-0 shadow-none" id="Weight" name="weight"> --}}
                            {{--                  </div> --}}
                            {{--                  <div class="form-group col-md-6"> --}}
                            {{--                     <label for="inputAddress">{{ __('sentence.Patient Height') }}<font color="red">*</font></label> --}}
                            {{--                     <input type="text" class="form-control rounded-0 shadow-none" id="height" name="height"> --}}
                            {{--                  </div> --}}
                        ...
                        <div class="form-row">
                            ...
                            {{--                            <input type="text" class="form-control rounded-0 shadow-none" id="nbenfant" name="nbenfant"> --}}
                            {{--                        </div> --}}
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                            ...
                            {{--                            <input type="text" class="form-control rounded-0 shadow-none" id="Province" name="Province"> --}}
                            {{--                            </div> --}}
                            {{--                        <div class="form-group col-md-3"> --}}
                            {{--                            <label for="inputAddress2">{{ __('sentence.Code postal') }}</label> --}}
                            {{--                            <input type="text" class="form-control rounded-0 shadow-none" id="postal" name="postal"> --}}
                            {{--                        </div> --}}
                            <div class="form-group col-md-3">
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                <button type="submit"
                                    class="btn btn-primary rounded-0 rounded-0 ">{{ __('sentence.Save') }}</button>
                            </div>
                        </div>
