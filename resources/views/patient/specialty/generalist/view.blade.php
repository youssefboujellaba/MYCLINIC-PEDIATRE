                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            @else
                                @if($patient->Patient->gender == 'Homme' || $patient->Patient->gender == '')
                                    <center><img src="{{ asset('img/homme.png') }}"
                                                 class="img-profile rounded-circle img-fluid" width="256" height="256">
                                    </center>
                                @endif
                                @if($patient->Patient->gender == 'Femme' || $patient->Patient->gender == 'Female')
                                    <center><img src="{{ asset('img/femme.png') }}"
                                                 class="img-profile rounded-circle img-fluid" width="256" height="256">
                                    </center>
                                @endif
                                @if($patient->Patient->gender == 'Enfant' || $patient->Patient->gender == 'Garçon')
                                    <center><img src="{{ asset('img/garson.png') }}"
                                                 class="img-profile rounded-circle img-fluid" width="256" height="256">
                                    </center>
                                @endif
                                @if($patient->Patient->gender == 'Fille' || $patient->Patient->gender == 'Fille')
                                    <center><img src="{{ asset('img/fille.png') }}"
                                                 class="img-profile rounded-circle img-fluid" width="256" height="256">
                                    </center>
                                @endif
                            @endempty
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="documents-tab" data-toggle="tab" href="#documents"
                                       ...
                                       aria-selected="false">{{ __('sentence.Health History') }}</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                        ...
                                        <div class="col">
                                            @can('create appointment')
                                                <a type="button" class="btn btn-primary btn-sm my-4 float-right"
                                                   href="{{ route('appointment.create') }}"><i
                                        ...
                                        @forelse($appointments as $appointment)
                                            <tr>
                                                ...
                                                <td align="center"><label class="badge badge-primary-soft"><i
                                                            class="fas fa-calendar"></i> {{ $appointment->date->format('d M Y') }}
                                                    </label></td>
                                                <td align="center"><label class="badge badge-primary-soft"><i
                                        ...
                                        <div class="col">
                                            @can('create prescription')
                                                <a class="btn btn-primary btn-sm my-4 float-right"
                                                   href="{{ route('prescription.create')}}"><i
                                                        class="fa fa-pen"></i> {{ __('sentence.Write New Prescription') }}
                                                </a>
                                            @endcan
                                        </div>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a id="consultationLink"
                                                       href="{{ route('consultation.list', ['id' => $act->consultation_id]) }}"
                                                       class="consultationLink" data-id="{{$act->consultation_id}}"
                                                       data-toggle="modal" data-target="#consultationModal"
                                                       data-placement="top" title="Liste de consultation">
                                                        <i class="fas fa-list"></i>
                                                    </a>
                                                    <a id="paiementLink"
                                                       href="{{ route('paiement.list', ['id' => $act->consultation_id]) }}"
                                                       class="paiementLink" data-toggle="modal"
                                                       data-id="{{$act->consultation_id}}" data-target="#paiementModal"
                                                       data-placement="top" title="Liste de paiement">
                                                        <i class="fas fa-dollar-sign"></i>
                                                    </a>
                                                    <a id="seancesLink"
                                                       href="{{ route('seance.list', ['id' => $act->consultation_id]) }}"
                                                       class="seancesLink" data-id="{{$act->consultation_id}}"
                                ...
                                <div class="tab-pane fade" id="Billing" role="tabpanel" aria-labelledby="Billing-tab">
                                    ...
                                    <table class="table">
                                        ...
                                        @forelse($invoices as $invoice)
                                            <tr>
                                                <td>
                                                    <a href="{{ url('billing/view/'.$invoice->id) }}">{{ $invoice->reference }}</a>
                                                </td>
                                                ...
                                                @endphp
                                                <td class="text-center">
                                                    <a href="#" data-toggle="modal" data-id="{{ $invoice->id }}"
                                                ...
                                                <td class="text-center">
                                                    <label class="badge badge-primary-soft">
                                                        ...
                                                        <input type="hidden" name="label" id="label"
                                                               value="{{ $rapport_type->rapport_label }}">
                                                    </label>
                                                    <label class="badge badge-primary-soft">
                                                    </label>
                                                </td>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"
                        id="exampleModalLabel">{{ __('sentence.You are about to modify an appointment') }}</h5>
