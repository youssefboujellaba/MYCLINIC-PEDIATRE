                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            ...
                            @endisset
                            @isset($patient->Patient->nomPere)
                                <p><b>Nom du pére : </b> {{ $patient->Patient->nomPere }}</p>
                            @endisset

                            @isset($patient->Patient->professionPere)
                                <p><b>Profession du pere : </b> {{ $patient->Patient->professionPere }}</p>
                            @endisset

                            @isset($patient->Patient->nomMere)
                                <p><b>Nom de la mere : </b> {{ $patient->Patient->nomMere }}</p>
                            @endisset

                              @isset($patient->Patient->professionMere)
                                <p><b>Profession de la mere : </b> {{ $patient->Patient->professionMere }}</p>
                            @endisset
                                        ...
                                        @if(isset($history->traitement))
                                            <div class="row mt-2">
                                                <div class="col">
                                                    ...
                                                    @endcan
                                                    <textarea class="form-control alert alert-danger" name="traitement" id="myTextarea" rows="4" placeholder="" value="{{$history->traitement}}" readonly>{{$history->traitement}}</textarea>
                                                </div>
                                            </div>
                                        @endif
                                    @empty
