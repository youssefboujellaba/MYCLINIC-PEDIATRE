    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-4">
                    <a href="{{ route('appointment.create') }}" class="btn rounded-0  btn-primary btn-sm float-right"><i
...
@section('header')
    ...
    <link href='https://www.jqueryscript.net/demo/Full-Size-Drag-Drop-Calendar-Plugin-FullCalendar/fullcalendar.min.css'
          rel='stylesheet' />
@endsection

@section('footer')
    <script src='https://www.jqueryscript.net/demo/Full-Size-Drag-Drop-Calendar-Plugin-FullCalendar/fullcalendar.min.js'>
    </script>
@endsection
