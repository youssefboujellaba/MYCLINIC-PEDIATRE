            ...
            <form method="post" action="{{ route('payment.store_edit') }}">
               <div class="form-group row">
                  ...
                  <div class="col-sm-12">
                     ...
                     <input type="text" class="form-control" id="payment_name" name="name" value="{{ $payment->name }}">
                  </div>
               ...
               <div class="form-group row">
                  ...
                  <label for="inputEmail3" class="col-sm-3 col-form-label" style="display: none">{{ __('sentence.Tests') }}<font color="red">*</font></label>
